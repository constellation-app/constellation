...
| Action**        | Shortcut**      |                 |                 |
+=================+=================+=================+=================+
| Open Named      | Ctrl + Shift +  | Views -\> Named | ::              |
| Selections      | N               | Selections      | : {style="text- |
|                 |                 |                 | align: center"} |
|                 |                 |                 | ![](            |
|                 |                 |                 | ../resources/na |
|                 |                 |                 | med_selections. |
...
\"Intersection\" button. This will result in all common elements from
each Named Selection (and the graph if *\<Current Selection\>* has been
...
\"Clone Selection\" from the menu. This will create a new named
selection that contains all of the elements that the original Named
Selection contained.
...
right-clicking and selecting \"Rename Selection\". A prompt is shown
where a new name can be entered.
