...
public class SelectNamedSelectionPanel extends JPanel {
    ...
    public SelectNamedSelectionPanel(final List<NamedSelection> namedSelections, String labelText) {
        ...
        this.useSelectedElementsRadioButton.setEnabled(false); // Should not use selected elements when calling this constructor
    }
    ...
    public SelectNamedSelectionPanel(final List<NamedSelection> namedSelections, String labelText, final boolean nsMode) {
        ...
        this.buttonGroup1.add(useSelectedElementsRadioButton);
        ...
        this.useSelectedElementsRadioButton.setSelected(!nsMode);
    ...
    public int getNamedSelectionId() {
        if (useSelectedElementsRadioButton.isSelected()) {
            return USE_CURRENTLY_SELECTED;
        }
        final int ix = nsList.getSelectedIndex();
        return ix > -1 ? namedSelections.get(ix).getID() : NO_OPTION_SELECTED;
    }
    ...
    private void initComponents() {
        ...
        useSelectedElementsRadioButton = new javax.swing.JRadioButton();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(useSelectedElementsRadioButton, org.openide.util.NbBundle.getMessage(SelectNamedSelectionPanel.class, "SelectNamedSelectionPanel.useSelectedElementsRadioButton.text")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(useSelectedElementsRadioButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(useSelectedElementsRadioButton)
    ...
    private javax.swing.JRadioButton useSelectedElementsRadioButton;
