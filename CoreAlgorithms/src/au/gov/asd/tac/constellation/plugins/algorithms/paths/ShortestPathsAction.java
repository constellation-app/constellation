...
@ActionRegistration(displayName = "#CTL_ShortestPathsAction", iconBase = "au/gov/asd/tac/constellation/plugins/algorithms/paths/shortestpaths.png", surviveFocusChange = true)
@ActionReferences({
