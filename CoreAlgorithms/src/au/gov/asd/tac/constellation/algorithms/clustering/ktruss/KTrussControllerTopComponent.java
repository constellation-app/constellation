 ...
 */
@ConvertAsProperties(
        dtd = "-//au.gov.asd.tac.constellation.algorithms.clustering//KTruss//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "KTrussControllerTopComponent",
        iconBase = "au/gov/asd/tac/constellation/algorithms/clustering/ktruss/ktruss.png",
...
@ActionID(
        category = "Views",
        id = "au.gov.asd.tac.constellation.algorithms.clustering.ktruss.KTrussControllerTopComponent"
)
@ActionReferences({
