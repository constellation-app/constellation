 ...
 * @author algol
 */
@ActionID(category = "Tools", id = "au.gov.asd.tac.constellation.algorithms.paths.ShortestPathsFollowDirectionAction")
@ActionRegistration(displayName = "#CTL_ShortestPathsFollowDirectionAction", iconBase = "au/gov/asd/tac/constellation/algorithms/paths/shortestpathsfd.png", surviveFocusChange = true)
@ActionReferences({
