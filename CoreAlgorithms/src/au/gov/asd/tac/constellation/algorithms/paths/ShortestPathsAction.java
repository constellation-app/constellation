...
@ActionRegistration(displayName = "#CTL_ShortestPathsAction", iconBase = "au/gov/asd/tac/constellation/algorithms/paths/shortestpaths.png", surviveFocusChange = true)
@ActionReferences({
