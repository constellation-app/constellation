...
import au.gov.asd.tac.constellation.algorithms.clustering.infomap.traits.FlowDirectedNonDetailedBalanceWithTeleportation;
...
public class InfomapDirectedUnrecordedTeleportation extends InfomapGreedy {
    ...
    public static class NodeFactoryDirectedUnrecordedTeleportation implements NodeFactoryBase {
        ...
        public NodeBase createNode(final NodeBase node) {
            return new Node(node.name, (FlowDirectedNonDetailedBalanceWithTeleportation) ((Node) node).getData());
        }
