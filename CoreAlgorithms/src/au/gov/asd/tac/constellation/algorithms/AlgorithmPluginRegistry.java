 ...
 */
package au.gov.asd.tac.constellation.algorithms;

import au.gov.asd.tac.constellation.algorithms.clustering.chinesewhispers.ChineseWhispersPlugin;
import au.gov.asd.tac.constellation.algorithms.clustering.infomap.InfoMapPlugin;
import au.gov.asd.tac.constellation.algorithms.paths.DirectedShortestPathsPlugin;
import au.gov.asd.tac.constellation.algorithms.paths.ShortestPathsPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.BetweennessCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.ClosenessCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.DegreeCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.EigenvectorCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.HitsCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.KatzCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.centrality.PagerankCentralityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.global.AverageDegreePlugin;
import au.gov.asd.tac.constellation.algorithms.sna.global.ComponentCountPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.global.GlobalClusteringCoefficientPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.global.GraphDensityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.global.GraphDistancePlugin;
import au.gov.asd.tac.constellation.algorithms.sna.metrics.ConnectivityDegreePlugin;
import au.gov.asd.tac.constellation.algorithms.sna.metrics.EccentricityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.metrics.EffectiveResistancePlugin;
import au.gov.asd.tac.constellation.algorithms.sna.metrics.LocalClusteringCoefficientPlugin;
...
import au.gov.asd.tac.constellation.algorithms.sna.similarity.AdamicAdarIndexPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.CommonNeighboursPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.CosineSimilarityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.DiceSimilarityPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.JaccardIndexPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.LevenshteinDistancePlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.PreferentialAttachmentPlugin;
import au.gov.asd.tac.constellation.algorithms.sna.similarity.ResourceAllocationIndexPlugin;
import au.gov.asd.tac.constellation.algorithms.tree.SpanningTreePlugin;
