 ...
 * @author antares
 */
public class ExpandGraphPluginNGTest {
    ...
    /**
     * Test of edit method, of class ExpandGraphPlugin.
    ...
    public void testEdit() throws InterruptedException {
        ...
        final ExpandGraphPlugin instance = new ExpandGraphPlugin();
        final PluginInteraction interaction = new TextPluginInteraction();
        instance.edit(graph, interaction, null);

        assertEquals(graph.getFloatValue(attrX, vxId1), 11F);
        assertEquals(graph.getFloatValue(attrY, vxId1), 22F);
        assertEquals(graph.getFloatValue(attrZ, vxId1), 33F);
        assertEquals(graph.getFloatValue(attrX, vxId2), -11F);
        assertEquals(graph.getFloatValue(attrY, vxId2), -22F);
        assertEquals(graph.getFloatValue(attrZ, vxId2), -33F);
    }
    
    /**
     * Test of edit method, of class ExpandGraphPlugin. A node selected.
     * @throws java.lang.InterruptedException
     */
    @Test
