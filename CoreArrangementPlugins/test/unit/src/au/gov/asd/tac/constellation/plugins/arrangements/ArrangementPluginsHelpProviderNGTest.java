...
public class ArrangementPluginsHelpProviderNGTest {
    ...
    public void testGetHelpMap() {
        ...
        assertEquals(helpMap.size(), 18);
        //not going to go through and assert the existence of each specific item in the map 
        //but will assert they're all correctly located within the arrangements package
        final String packageStart = "au.gov.asd.tac.constellation.plugins.arrangements.";
    ...
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CoreArrangementPlugins"));
        assertTrue(tocLocation.contains("arrangements-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CoreArrangementPlugins"));
        assertTrue(tocLocation.indexOf("CoreArrangementPlugins") < tocLocation.indexOf("arrangements-toc.xml"));
    }
}
