 ...
 * @author antares
 */
public class GridArrangerNGTest {
    ...
    /**
     * Test of arrange method, of class GridArranger. Passing through the default parameter values.
     * @throws java.lang.InterruptedException
     */
    @Test
    public void testArrangeDefault() throws InterruptedException {
        System.out.println("arrangeDefault");
        ...
        final GridArranger instance = new GridArranger();
        instance.arrange(graph);
        
        // should end up with a square arranged in vxId order
        // 4 5
        // 1 2 3
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId1), -3.5F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId1), -1.75F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId1), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId2), 0F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId2), -1.75F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId2), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId3), 3.5F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId3), -1.75F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId3), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId4), -3.5F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId4), 1.75F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId4), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId5), 0F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId5), 1.75F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId5), 0F);
    }
    
    /**
     * Test of arrange method, of class GridArranger. Passing through the custom parameter values.
     * @throws java.lang.InterruptedException
     */
    @Test
    public void testArrangeCustom() throws InterruptedException {
        System.out.println("arrangeCustom");
        ...
        final GridChoiceParameters params = new GridChoiceParameters(GridChoice.SQUARE, 1.5F, 2, 3, false);
        
        final GridArranger instance = new GridArranger(params);
        instance.arrange(graph);
        
        // should end up with a square arranged in vxId order
        // 4 5
        // 1 2 3
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId1), -5F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId1), -3F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId1), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId2), 0F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId2), -3F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId2), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId3), 5F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId3), -3F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId3), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId4), -5F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId4), 3F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId4), 0F);
        
        assertEquals(graph.getFloatValue(xNodeAttribute, vxId5), 0F);
        assertEquals(graph.getFloatValue(yNodeAttribute, vxId5), 3F);
        assertEquals(graph.getFloatValue(zNodeAttribute, vxId5), 0F);
    }
}
