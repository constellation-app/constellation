 ...
 * @author antares
 */
public class VertexListInclusionGraphNGTest {
    ...
    private List<Integer> includedVertices;
    ...
    public void setUpMethod() throws Exception {
        ...
        includedVertices = Arrays.asList(vxId1, vxId2, vxId3);
    }
    ...
    public void testGetInclusionGraph() {
        ...
        final VertexListInclusionGraph instance = new VertexListInclusionGraph(graph, Connections.NONE, includedVertices);
    ...
    public void testGetInclusionGraphTransaction() {
        ...
        final VertexListInclusionGraph instance = new VertexListInclusionGraph(graph, Connections.TRANSACTIONS, includedVertices);
        final GraphWriteMethods inclusionGraph = instance.getInclusionGraph();
    ...
    public void testGetInclusionGraphEdge() {
        ...
        final VertexListInclusionGraph instance = new VertexListInclusionGraph(graph, Connections.EDGES, includedVertices);
        final GraphWriteMethods inclusionGraph = instance.getInclusionGraph();
    ...
    public void testGetInclusionGraphLink() {
        ...
        final VertexListInclusionGraph instance = new VertexListInclusionGraph(graph, Connections.LINKS, includedVertices);
        final GraphWriteMethods inclusionGraph = instance.getInclusionGraph();
