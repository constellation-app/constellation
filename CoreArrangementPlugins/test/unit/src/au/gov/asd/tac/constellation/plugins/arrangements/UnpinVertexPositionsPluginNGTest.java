 ...
 * @author antares
 */
public class UnpinVertexPositionsPluginNGTest {
    ...
    /**
     * Test of edit method, of class UnpinVertexPositionsPlugin.
    ...
    public void testEdit() throws InterruptedException {
        ...
        final UnpinVertexPositionsPlugin instance = new UnpinVertexPositionsPlugin();
        instance.edit(graph, null, null);
        
        // should become unpinned since it was selected
        assertFalse(graph.getBooleanValue(pinnedVertexAttribute, vxId1));
        // should remain unpinned (already being unpinned shouldn't affect it)
        assertFalse(graph.getBooleanValue(pinnedVertexAttribute, vxId2));
        // remains pinned
        assertTrue(graph.getBooleanValue(pinnedVertexAttribute, vxId3));
        // remains unpinned despite not being selected (plugin shouldn't replace pinned group)
        assertFalse(graph.getBooleanValue(pinnedVertexAttribute, vxId4));
    }
}
