...
public abstract class Point3D implements Cloneable {
    ...
    /**
     * The <code>Float</code> class defines a point specified in float precision.
     */
    public static class Float extends Point3D implements Serializable {
         ...
         *
         * @param x the X coordinate of the newly * constructed <code>Point3D</code>
         * @param y the Y coordinate of the newly * constructed <code>Point3D</code>
         * @param z the Z coordinate of the newly * constructed <code>Point3D</code>
         */
     ...
     * available for instantiation and provide a number of formats for storing the information necessary to satisfy the
     ...
     * object.
     *
     * @param p the specified <code>Point3D</code> to which to set * this <code>Point3D</code>
     */
     ...
     *
     * @param px the X coordinate of the specified point to be measured against this <code>Point3D</code>
     * @param py the Y coordinate of the specified point to be measured against this <code>Point3D</code>
     * @param pz the Z coordinate of the specified point to be measured against this <code>Point3D</code>
     ...
     *
     * @param pt the specified point to be measured against * this <code>Point3D</code>
     ...
     * their <code>x</code>, <code>y</code> and <code>z</code> member fields, representing their position in the
