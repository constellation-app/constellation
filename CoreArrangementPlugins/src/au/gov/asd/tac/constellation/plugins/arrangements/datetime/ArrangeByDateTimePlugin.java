...
@NbBundle.Messages("ArrangeByDateTimePlugin=Arrange by DateTime")
@PluginInfo(pluginType = PluginType.DISPLAY, tags = {PluginTags.MODIFY})
public class ArrangeByDateTimePlugin extends SimpleEditPlugin {

    //public static final String ROOTS_PARAMETER_ID = PluginParameter.buildId(ArrangeByDateTimePlugin.class, "roots");
    ...
    protected void edit(final GraphWriteMethods wg, final PluginInteraction interaction, final PluginParameters parameters) throws InterruptedException, PluginException {
        ...
        final Arranger arranger = new DateTimeArranger();
