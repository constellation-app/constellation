...
roots of each component\'s tree. Only one component is required to have
a root: if any other components do not have roots in the named
selection, an arbitrary node will be chosen. If you are unfamiliar with
named selections, select the nodes that will be the roots of the tree,
and press Ctrl-Shift-1. This will create a new named selection called
\"Selection *n*\", which will be visible in the \"Named Selections\"
window.
