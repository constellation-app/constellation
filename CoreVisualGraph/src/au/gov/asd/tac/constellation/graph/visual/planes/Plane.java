 ...
 */
package au.gov.asd.tac.constellation.graph.visual.planes;
...
public final class Plane {
    ...
    static Plane readNode(final JsonNode jnode, final GraphReadMethods graph, final GraphByteReader byteReader) throws IOException {
    ...
    void writeNode(final JsonGenerator jg, final GraphByteWriter byteWriter) throws IOException {
