...
public final class PermanentMergePanel extends JPanel {
    ...
    /**
     * this method will generate a list of the attribute columns (for a given element type) and display them in the
     * 'from' listing
     *
    ...
    /**
     * this method will setup the object that gathers the selected attributes for the merged node
     */
    ...
    /**
     * method used to process the selected cell and update the set of selected attributes
     *
     * @return ArrayList
     */
    ...
    /**
     * Updates the tabular display to display the contents of the graph element that the panel is responsible for.
     */
