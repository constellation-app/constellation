...
public class DecoratorsAttributeInteraction extends AbstractAttributeInteraction<Decorators> {
    ...
    public String getDisplayText(final Object attrVal) {
        ...
        final Decorators decoratorsVal = ((Decorators) attrVal);
    ...
    @Override
    protected Class<Decorators> getValueType() {
