 ...
 * @author antares
 */
public class SelectBackbonePluginNGTest {
    ...
    /**
     * Test of edit method, of class SelectBackbonePlugin.
    ...
    public void testEdit() throws InterruptedException {
        ...
        final SelectBackbonePlugin instance = new SelectBackbonePlugin();
        ...
        assertTrue(graph.getBooleanValue(selectedVertexAttribute, vxId6));
        ...
        assertFalse(graph.getBooleanValue(selectedTransactionAttribute, tId4));
        assertTrue(graph.getBooleanValue(selectedTransactionAttribute, tId5));
        assertTrue(graph.getBooleanValue(selectedTransactionAttribute, tId6));
        assertTrue(graph.getBooleanValue(selectedTransactionAttribute, tId7));
        assertFalse(graph.getBooleanValue(selectedTransactionAttribute, tId8));
    }    
}
