...
public class HopHalfNGTest {
    ...
    public void singleHopTest() throws InterruptedException, PluginException {
        ...
        assertFalse(String.format("Node [%d] should de-selected", vxId1), graph.getBooleanValue(selectedVertexAttribute, vxId1));
        assertTrue(String.format("Node [%d] should selected", vxId2), graph.getBooleanValue(selectedVertexAttribute, vxId2));
        assertFalse(String.format("Node [%d] should de-selected", vxId3), graph.getBooleanValue(selectedVertexAttribute, vxId3));
        assertFalse(String.format("Node [%d] should de-selected", vxId4), graph.getBooleanValue(selectedVertexAttribute, vxId4));
        assertTrue(String.format("Node [%d] should selected", vxId5), graph.getBooleanValue(selectedVertexAttribute, vxId5));
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(selectedVertexAttribute, vxId6));
        assertTrue(String.format("Node [%d] should selected", vxId7), graph.getBooleanValue(selectedVertexAttribute, vxId7));
        assertFalse(String.format("Transaction [%d] should de-selected", txId1), graph.getBooleanValue(selectedTransactionAttribute, txId1));
        assertFalse(String.format("Transaction [%d] should de-selected", txId2), graph.getBooleanValue(selectedTransactionAttribute, txId2));
        assertFalse(String.format("Transaction [%d] should de-selected", txId3), graph.getBooleanValue(selectedTransactionAttribute, txId3));
        assertFalse(String.format("Transaction [%d] should de-selected", txId4), graph.getBooleanValue(selectedTransactionAttribute, txId4));
        assertFalse(String.format("Transaction [%d] should de-selected", txId5), graph.getBooleanValue(selectedTransactionAttribute, txId5));
        ...
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(selectedVertexAttribute, vxId6));
        assertTrue(String.format("Node [%d] should selected", vxId7), graph.getBooleanValue(selectedVertexAttribute, vxId7));
        assertTrue(String.format("Transaction [%d] should selected", txId1), graph.getBooleanValue(selectedTransactionAttribute, txId1));
        assertFalse(String.format("Transaction [%d] should de-selected", txId2), graph.getBooleanValue(selectedTransactionAttribute, txId2));
        assertTrue(String.format("Transaction [%d] should selected", txId3), graph.getBooleanValue(selectedTransactionAttribute, txId3));
        assertTrue(String.format("Transaction [%d] should selected", txId4), graph.getBooleanValue(selectedTransactionAttribute, txId4));
        assertTrue(String.format("Transaction [%d] should selected", txId5), graph.getBooleanValue(selectedTransactionAttribute, txId5));
    }
    ...
    public void singleHopTest2() throws InterruptedException, PluginException {
        ...
        assertTrue(String.format("Node [%d] should selected", vxId1), graph.getBooleanValue(selectedVertexAttribute, vxId1));
        assertFalse(String.format("Node [%d] should de-selected", vxId2), graph.getBooleanValue(selectedVertexAttribute, vxId2));
        assertFalse(String.format("Node [%d] should de-selected", vxId3), graph.getBooleanValue(selectedVertexAttribute, vxId3));
        assertFalse(String.format("Node [%d] should de-selected", vxId4), graph.getBooleanValue(selectedVertexAttribute, vxId4));
        assertFalse(String.format("Node [%d] should de-selected", vxId5), graph.getBooleanValue(selectedVertexAttribute, vxId5));
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(selectedVertexAttribute, vxId6));
        assertFalse(String.format("Node [%d] should de-selected", vxId7), graph.getBooleanValue(selectedVertexAttribute, vxId7));
        assertFalse(String.format("Transaction [%d] should de-selected", txId1), graph.getBooleanValue(selectedTransactionAttribute, txId1));
        assertFalse(String.format("Transaction [%d] should de-selected", txId2), graph.getBooleanValue(selectedTransactionAttribute, txId2));
        assertTrue(String.format("Transaction [%d] should selected", txId3), graph.getBooleanValue(selectedTransactionAttribute, txId3));
        assertFalse(String.format("Transaction [%d] should de-selected", txId4), graph.getBooleanValue(selectedTransactionAttribute, txId4));
        ...
        assertTrue(String.format("Node [%d] should selected", vxId2), graph.getBooleanValue(selectedVertexAttribute, vxId2));
        assertFalse(String.format("Node [%d] should de-selected", vxId3), graph.getBooleanValue(selectedVertexAttribute, vxId3));
        assertTrue(String.format("Node [%d] should selected", vxId4), graph.getBooleanValue(selectedVertexAttribute, vxId4));
        assertFalse(String.format("Node [%d] should de-selected", vxId5), graph.getBooleanValue(selectedVertexAttribute, vxId5));
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(selectedVertexAttribute, vxId6));
        assertFalse(String.format("Node [%d] should de-selected", vxId7), graph.getBooleanValue(selectedVertexAttribute, vxId7));
        assertTrue(String.format("Transaction [%d] should selected", txId1), graph.getBooleanValue(selectedTransactionAttribute, txId1));
        assertTrue(String.format("Transaction [%d] should selected", txId2), graph.getBooleanValue(selectedTransactionAttribute, txId2));
        assertTrue(String.format("Transaction [%d] should selected", txId3), graph.getBooleanValue(selectedTransactionAttribute, txId3));
        assertFalse(String.format("Transaction [%d] should de-selected", txId4), graph.getBooleanValue(selectedTransactionAttribute, txId4));
        assertFalse(String.format("Transaction [%d] should de-selected", txId5), graph.getBooleanValue(selectedTransactionAttribute, txId5));
    }
