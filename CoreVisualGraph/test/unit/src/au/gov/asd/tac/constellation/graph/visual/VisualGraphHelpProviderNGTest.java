 ...
 * @author antares
 */
public class VisualGraphHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class VisualGraphHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final VisualGraphHelpProvider instance = new VisualGraphHelpProvider();
        ...
        final String packageStart = "au.gov.asd.tac.constellation.graph.visual.";
    ...
    /**
     * Test of getHelpTOC method, of class VisualGraphHelpProvider.
     */
    @Test
