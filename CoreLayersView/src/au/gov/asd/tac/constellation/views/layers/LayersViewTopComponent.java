...
/**
 * The Layers View Top Component. This class provides the Layers View window and handles all interactions with the
 * graph.
 *
...
public final class LayersViewTopComponent extends JavaFxTopComponent<LayersViewPane> {
    ...
    public Tuple<String, Boolean> getDefaultFloatingInfo() {
        return Tuple.create(Bundle.CTL_LayersViewTopComponent(), Boolean.FALSE);
    }
