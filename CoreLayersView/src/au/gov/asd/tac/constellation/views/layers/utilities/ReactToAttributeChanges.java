...
public final class ReactToAttributeChanges extends SimpleEditPlugin {

    public ReactToAttributeChanges() {
    }
    ...
    public void edit(final GraphWriteMethods graph, final PluginInteraction interaction, final PluginParameters parameters) {
        ...
        PluginExecution.withPlugin(new TransactionEvaluator()).executeLater(GraphManager.getDefault().getActiveGraph());
    }
