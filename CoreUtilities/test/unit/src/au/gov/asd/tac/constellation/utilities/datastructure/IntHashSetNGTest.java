 ...
 *   - {@link IntHashSet#getAverageQueue IntHashSet.getAverageQueue()}, the average bucket size for each element
 *   - {@link IntHashSet#add IntHashSet.add(int)}, the id of the existing element if there is one
 * Everything else is internal to IntHashSet rendering it inaccessible to
 * anything short of reflection - which is slow and Constellation's test regime
 * is already giganticly slow.
 * 
...
public class IntHashSetNGTest implements Serializable {
    ...
    public class IntHashSetImpl extends IntHashSet {
        ...
        @Override
        protected int getHash(int element) { return 7 * element; }
    ...
    /**
     * An implementation of IntHashSet with a terrible hashing algorithm.
