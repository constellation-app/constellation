...
public class CameraUtilitiesNGTest {
    ...
    private BoundingBox getMockedRegionBoundingBox(final float cameraDistance, final Vector3f centre) {
    ...
    public void testRefocusXAxis() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(1250.099976F, 16.2F, 16.3F).toString());
        ...
        assertEquals(c2.lookAtEye.toString(), new Vector3f(-1217.900024F, 16.2F, 16.3F).toString());
        assertEquals(c2.lookAtUp.toString(), new Vector3f(0F, 1F, 0F).toString());
    }
    ...
    public void testRefocusYAxis() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(16.1F, 1250.199951F, 16.3F).toString());
        assertEquals(c.lookAtUp.toString(), new Vector3f(0F, 0F, -1F).toString());

        // refocus in the reverse direction
        final Camera c2 = new Camera(CAMERA);
        CameraUtilities.refocusOnYAxis(c2, region, true);
        assertEquals(c2.lookAtEye.toString(), new Vector3f(16.1F, -1217.800049F, 16.3F).toString());
        assertEquals(c2.lookAtUp.toString(), new Vector3f(0F, 0F, 1F).toString());
    }
    ...
    public void testRefocusZAxis() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(16.1F, 16.2F, 1250.300049F).toString());
        assertEquals(c.lookAtUp.toString(), new Vector3f(0F, 1F, 0F).toString());

        // refocus in the reverse direction
        final Camera c2 = new Camera(CAMERA);
        CameraUtilities.refocusOnZAxis(c2, region, true);
        assertEquals(c2.lookAtEye.toString(), new Vector3f(16.1F, 16.2F, -1217.699951F).toString());
        assertEquals(c2.lookAtUp.toString(), new Vector3f(0F, 1F, 0F).toString());
    }
    ...
    public void testPan() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(-13464.245117F, -13682.509766F, -14328.245117F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(-13465.245117F, -13683.509766F, -14329.245117F).toString());
    }
    ...
    public void testRotate() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(1.562712F, 2.200309F, 3.049615F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(0.294065F, 1.200462F, 2.424421F).toString());
        assertEquals(c.lookAtUp.toString(), new Vector3f(4.148406F, 3.147604F, 1.903505F).toString());
        ...
        assertEquals(c.lookAtCentre.toString(), new Vector3f(0.294069F, 1.200464F, 2.424422F).toString());

        // rotate Camera around its centre of rotation
        CameraUtilities.rotate(c, 17F, -618F);
        assertEquals(c.lookAtEye.toString(), new Vector3f(2.200911F, 2.000314F, 2.414548F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(1.251366F, 0.900471F, 1.471822F).toString());
        assertEquals(c.lookAtUp.toString(), new Vector3f(2.980435F, 3.628568F, 2.947968F).toString());
    }
    ...
    public void testSpin() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(2.099996F, 2.199996F, 2.299996F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(1.099992F, 1.199991F, 1.299991F).toString());
        assertEquals(c.lookAtUp.toString(), new Vector3f(3.277264F, 3.087054F, 3.235682F).toString());
    }
    ...
    public void testZoom() {
        ...
        assertEquals(c.lookAtEye.toString(), new Vector3f(-207.268860F, -222.833054F, -218.615417F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(-208.268860F, -223.833054F, -219.615417F).toString());

        // zooming in
        CameraUtilities.zoom(c, 13, new Vector3f(V14), 33F);
        assertEquals(c.lookAtEye.toString(), new Vector3f(-297.029968F, -319.330688F, -313.330109F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(-298.029968F, -320.330688F, -314.330109F).toString());

        // zooming out
        CameraUtilities.zoom(c, -78, new Vector3f(V17), 12.087F);
        assertEquals(c.lookAtEye.toString(), new Vector3f(-99.809128F, -107.293777F, -105.223038F).toString());
        assertEquals(c.lookAtCentre.toString(), new Vector3f(-100.809128F, -108.293777F, -106.223038F).toString());
    }
    ...
    public void testGetFocusVector() {
        assertEquals(CameraUtilities.getFocusVector(new Camera(CAMERA)).toString(), new Vector3f(-1F, -1F, -1F).toString());
    }
}
