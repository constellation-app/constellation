...
public class ConnectionGlyphStreamContext extends GlyphStreamContext{
    ...
    public ConnectionGlyphStreamContext(int totalScale, float visibility, int labelNumber, boolean isAttributeLabel) {
        super(totalScale, visibility, labelNumber);
        this.isAttributeLabel = isAttributeLabel;
    }    
    ...
    public ConnectionGlyphStreamContext(ConnectionGlyphStreamContext context) {
        ...
        isAttributeLabel = context.isAttributeLabel;
    }
}
