 ...
 */
public class MouseEnteredHyperlinkHandler implements EventHandler {
    private static final Logger LOGGER = Logger.getLogger(MouseEnteredHyperlinkHandler.class.getName());
    ...
    public MouseEnteredHyperlinkHandler(final Hyperlink hyperlink, final TooltipPane tooltipPane) {
