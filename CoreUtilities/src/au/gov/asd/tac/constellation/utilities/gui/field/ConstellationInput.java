...
public abstract class ConstellationInput<T> extends StackPane implements
    ...
    public ConstellationInput(final TextType type) {
        ...
        textArea.getStyleClass().addAll(JavafxStyleManager.getMainStyleSheet());
    }
     ...
     * ensure appropriate resizing with contained text.  
     ...
     */
    @Override
    public final void changed(final ObservableValue<? 
            extends Serializable> observable, final Serializable oldValue, final Serializable newValue) {
     ...
     * This functionality has been captured in the base class intentionally
     *  to consistency across all input fields regarding context displaying 
     * 
     * @param menu 
     */
