...
import au.gov.asd.tac.constellation.utilities.testing.ConstellationTest; 
 public class WebServerNGTest extends ConstellationTest {
    ...
    @Test
    public void testEqualScripts() {
        final File ipython = getScriptDir(true);
        final File download = new File(ipython, WebServer.CONSTELLATION_CLIENT);
        final boolean equal = WebServer.equalScripts(download);
