...
public class NewAttributeDialogNGTest {
    ...
    public void testConstructor() {
        ...
        // testing these all here since these are values generated by the constructor
        // separating out into own tests with new instance for each caused config failures
        assertEquals(instance.getType(), "string");
