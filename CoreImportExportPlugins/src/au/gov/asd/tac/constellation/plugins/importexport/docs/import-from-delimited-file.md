...
Attributes column there is a pseudo-attribute called
[\_\_directed\_\_]{.mono} which can be used to create directed and
undirected transactions as required. The [\_\_directed\_\_]{.mono}
pseudo-attribute is a boolean that will cause a transaction to be
directed when its value is (case-insensitively) \"true\", and undirected
otherwise.
...
[*HOME_DIRECTORY*/.CONSTELLATION/ImportDelimited]{.mono}. (The name of
