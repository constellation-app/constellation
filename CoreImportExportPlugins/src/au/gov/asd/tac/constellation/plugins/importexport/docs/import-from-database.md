...
"&lt;HOME_DIRECTORY&gt;/.CONSTELLATION/DatabaseImporterTemplates". (The name of the file in
...
2.  Navigate to the folder called "DatabaseImporterTemplates"
3.  Give the appropriate .json file to a recipient
4.  Upon receiving the file, they can follow these steps to save that
    .json file inside the "DatabaseImporterTemplates" directory
