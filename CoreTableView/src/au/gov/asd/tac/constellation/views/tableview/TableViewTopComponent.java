...
public final class TableViewTopComponent extends TopComponent implements PropertyChangeListener, ListSelectionListener, GraphChangeListener, LookupListener, UndoRedo.Provider, PreferenceChangeListener {
    ...
    public void valueChanged(final ListSelectionEvent e) {
        ...
        try {
            ...
            final Future<?> future = PluginExecution.withPlugin(new UpdateSelectionPlugin(e, dataTable, elementType, selectedAttrId, lsm)).executeLater(graph);
...
//            // Record the state of the table so we can restore it when the user comes back to this graph.
    ...
    /**
     * Plugin to update selection;
     */
    @PluginInfo(pluginType = PluginType.SELECTION, tags = {"SELECT"})
    protected static class UpdateSelectionPlugin extends SimpleEditPlugin {

        private final ListSelectionEvent e;
        private final JTable dataTable;
        private final GraphElementType elementType;
        private final int selectedAttrId;
        private final ListSelectionModel lsm;

        protected UpdateSelectionPlugin(final ListSelectionEvent e, final JTable dataTable, final GraphElementType elementType, final int selectedAttrId, final ListSelectionModel lsm) {
            this.e = e;
        ...
        public String getName() {
            return "Table View: Update Selection";
        }
