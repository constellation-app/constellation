...
-   ![](resources/selectNode.png){width="20" height="20"}: View the node
    attributes

-   ![](resources/selectTransaction.png){width="20" height="20"}: View
    the transaction attributes

### Column Definition

The set of columns displayed in the table can be modified by selecting
the button ![](resources/editColumns.png){width="20" height="20"}.\
...
![](resources/copydialog.png){width="544" height="452"}
...
\"Copy selected row(s) only\" check box allows user to choose whether
they would like to copy all rows or just the rows that are currently
selected.
