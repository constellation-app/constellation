...
/**
 * De-serializer for the {@link Pair} object that represent the column sort order. If
 * the sort direction is null or an empty string then ascending is chosen.
 * <p/>
 * This de-serializer is being used primarily to handle the setting of the default
 * sort order when the value in the JSON is an empty string. This only happens in
 * preferences saved prior to version 2.5.
 * 
 * @author formalhaunt
 */
public class ColumnSortOrderDeserializer extends JsonDeserializer<Pair<String, TableColumn.SortType>> {
     ...
     * @throws JsonProcessingException if there is an issue de-serializing the JSON
     */
    @Override
