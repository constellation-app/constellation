...
public class ColumnVisibilityContextMenuNGTest {
    ...
    /**
     * Verify the construction of a checkbox that allows the visibility updating of an individual
     * column. Verifies its current selection, text and expected actions.
     * 
     ...
     * @param expectedColumnAttributes the expected columns to be updated when the
     *     menu item is clicked
     * @param expectedUpdateMethod the expected method of column visibility updating when
    ...
    /**
     * Verifies the actions taken when button is clicked that provides standard column
     * visibility settings like show all.
     *
     ...
     * @param isHideOnClick true if hideOnClick is expected to be true, otherwise false
     */
     ...
     * representing a filter that will effect those other items. For the purposes
     * of this, it ignores the filter (other than verify it is there) and just
     * verifies that the correct columns are present.
     *
     * @param customMenuItem the menu containing the columns and filter
     * @param expectedColumnCheckBoxes the expected column check boxes in the menu
     */
