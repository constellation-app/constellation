 ...
 * @author antares
 */
public class TableViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class TableViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final TableViewHelpProvider instance = new TableViewHelpProvider();
        ...
        //but will assert they're all correctly located within the table view package
        final String packageStart = "au.gov.asd.tac.constellation.views.tableview.";
    ...
    /**
     * Test of getHelpTOC method, of class TableViewHelpProvider.
     */
    @Test
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CoreTableView"));
        assertTrue(tocLocation.contains("src"));
        assertTrue(tocLocation.contains("views"));
        assertTrue(tocLocation.contains("tableview"));
        assertTrue(tocLocation.contains("tableview-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CoreTableView"));
        assertTrue(tocLocation.indexOf("CoreTableView") < tocLocation.indexOf("src"));
        assertTrue(tocLocation.indexOf("src") < tocLocation.indexOf("views"));
        assertTrue(tocLocation.indexOf("views") < tocLocation.indexOf("tableview"));
        assertTrue(tocLocation.indexOf("tableview") < tocLocation.indexOf("tableview-toc.xml"));
    }   
}
