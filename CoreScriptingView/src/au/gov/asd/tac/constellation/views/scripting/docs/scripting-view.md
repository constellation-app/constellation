...
| Action**        | Shortcut**      |                 |                 |
+=================+=================+=================+=================+
| Open Scripting  | Ctrl + Shift +  | Views -\>       | ::              |
| View            | X               | Scripting View  | : {style="text- |
|                 |                 |                 | align: center"} |
|                 |                 |                 | ![](../         |
|                 |                 |                 | scripting_view. |
|                 |                 |                 | png){width="16" |
...
-   *graph* - This object represents the current active graph, and
    allows you to take a copy for reading from using
    \"readableGraph()\", or a copy for writing to using
    \"writableGraph(editName)\". For information on how to use this
    object, refer to the
...
-   *utilities* - This object provides various convenience functions
    provided by the core developers (e.g. \"openFile(dirKey)\" to
    activate a Netbeans file open dialog and return the selected file
    path as a string). If your chosen scripting language is Python, you
    can use its \"dir\" function to see what else is available,
