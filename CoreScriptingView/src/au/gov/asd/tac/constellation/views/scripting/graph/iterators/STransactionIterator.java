 ...
 * @author cygnus_x-1
 */
public class STransactionIterator implements Iterator<STransaction> {

    private final GraphReadMethods readableGraph;
    private final int transactionCount;
    private int currentPosition;

    public STransactionIterator(final GraphReadMethods readableGraph) {
        this.readableGraph = readableGraph;
        this.transactionCount = readableGraph.getTransactionCount();
    ...
    public STransaction next() {
        ...
        final int transactionId = readableGraph.getTransaction(currentPosition++);
