...
[Skip navigation links](SWritableGraph.md#skip.navbar.top "Skip navigation links")
...
-   [<span
    class="typeNameLink">Prev Class</span>](SVertex.md "class in au.gov.asd.tac.constellation.views.scripting.graph")
-   Next Class
...
-   Summary: 
-   Nested | 
-   [Field](SWritableGraph.md#fields.inherited.from.class.au.gov.asd.tac.constellation.views.scripting.graph.SReadableGraph) | 
-   Constructor | 
-   [Method](SWritableGraph.md#method.summary)
...
-   Field | 
-   Constructor | 
-   [Method](SWritableGraph.md#method.detail)
...
-   -   [au.gov.asd.tac.constellation.views.scripting.graph.SReadableGraph](SReadableGraph.md "class in au.gov.asd.tac.constellation.views.scripting.graph")
...
-   -   <span id="field.summary"></span>
        ...
        -   <span
            ...
            ### Fields inherited from class au.gov.asd.tac.constellation.views.scripting.graph.[SReadableGraph](SReadableGraph.md "class in au.gov.asd.tac.constellation.views.scripting.graph")
    ...
    -   <span id="method.summary"></span>
        ...
        -   <span
            ...
            ### Methods inherited from class au.gov.asd.tac.constellation.views.scripting.graph.[SReadableGraph](SReadableGraph.md "class in au.gov.asd.tac.constellation.views.scripting.graph")
...
-   -   <span id="method.detail"></span>
        ...
        -   #### commit
            ...
            [`rollback()`](SWritableGraph.md#rollback--)
        ...
        -   #### rollback
            ...
            [`commit()`](SWritableGraph.md#commit--)
            should be called immediately after you finish writing to the
            graph.
