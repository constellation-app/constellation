...
public class FileParameterTypeNGTest {
     ...
     */
    @Test
    public void testBuildTwoParameterFilter() {
        System.out.println("buildTwoParameterFilter");

        final ExtensionFilter filter = new FileChooser.ExtensionFilter("Text files", FileExtensionConstants.TEXT);
        final PluginParameter<FileParameterValue> fileParam = FileParameterType.build("My File", filter);
