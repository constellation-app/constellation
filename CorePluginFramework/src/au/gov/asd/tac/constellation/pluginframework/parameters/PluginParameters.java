...
import au.gov.asd.tac.constellation.pluginframework.gui.PluginParametersPane.ParameterLayout;
 ...
 * single plugin. Each
 * {@link au.gov.asd.tac.constellation.pluginframework.Plugin} has the
...
public class PluginParameters implements PluginParameterListener {
    ...
    public static class PluginParametersNode {
         ...
         * {@link au.gov.asd.tac.constellation.pluginframework.gui.PluginParametersPane}
         *
