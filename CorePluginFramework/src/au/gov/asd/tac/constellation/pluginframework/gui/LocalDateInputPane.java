 ...
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.types.LocalDateParameterType}.
 * <p>
 * Selecting a date will set the local date value of the underlying
 * {@link PluginParameter}.
 *
 * @see
 * au.gov.asd.tac.constellation.pluginframework.parameters.types.LocalDateParameterType
 *
 * @author algol
 */
