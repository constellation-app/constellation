...
import au.gov.asd.tac.constellation.pluginframework.parameters.RecentValuesChangeEvent;
import au.gov.asd.tac.constellation.pluginframework.parameters.RecentValuesListener;
 ...
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.types.StringParameterType}.
 * <p>
 * Editing the value in the text box will set the string value for the
 * underlying {@link PluginParameter}.
 *
 * @see
 * au.gov.asd.tac.constellation.pluginframework.parameters.types.StringParameterType
 *
 * @author ruby_crucis
 */
