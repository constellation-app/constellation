 ...
 * of
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.types.ActionParameterType}.
 * <p>
 * This button will fire a {@link ParameterChange} for the underlying
 * {@link PluginParameter}. Plugins using this should call
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters#addController(String, PluginParameterController) }
 * to the parameter inside
 * {@link au.gov.asd.tac.constellation.pluginframework.Plugin#createParameters}
 * so that the desired action will be performed after the ParameterChange is
 * fired.
 *
 * @see
 * au.gov.asd.tac.constellation.pluginframework.parameters.types.ActionParameterType
 * @author algol
 */
