 ...
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.types.SingleChoiceParameterType}.
 * <p>
 * Selecting an item from the drop-down will set the choice data for the
 * underlying {@link PluginParameter}.
 *
 * @see
 * au.gov.asd.tac.constellation.pluginframework.parameters.types.SingleChoiceParameterType
 *
 * @author ruby_crucis
 */
