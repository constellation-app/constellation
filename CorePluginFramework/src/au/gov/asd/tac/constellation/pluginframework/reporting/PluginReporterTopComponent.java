 ...
 */
@ConvertAsProperties(
        dtd = "-//au.gov.asd.tac.constellation.pluginframework.reporting//PluginReporter//EN",
        autostore = false
)
...
@ActionID(
        category = "Window",
        id = "au.gov.asd.tac.constellation.pluginframework.reporting.PluginReporterTopComponent"
)
@ActionReferences({
