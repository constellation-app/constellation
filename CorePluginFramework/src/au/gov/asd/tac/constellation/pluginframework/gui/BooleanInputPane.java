 ...
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.types.BooleanParameterType}.
 * <p>
 * Checking and un-checking the box will set the boolean value for the
 * underlying {@link PluginParameter}.
 *
 * @see
 * au.gov.asd.tac.constellation.pluginframework.parameters.types.BooleanParameterType
 *
 * @author ruby_crucis
 */
