...
public class PluginExecution {
     ...
     * <li><b>parameters</b>: default parameters for plugin (to modify see {@link PluginExecution#withParameters(au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters)},
     ...
     * {@link PluginExecution#synchronizingOn(au.gov.asd.tac.constellation.pluginframework.PluginSynchronizer)}.
     * <li><b>environment</b>: the default environment
     * {@link PluginEnvironment#getDefault()} (to modifiy see
     * {@link PluginExecution#inEnvironment(au.gov.asd.tac.constellation.pluginframework.PluginEnvironment)}.
     * </ol>
     *
     ...
     * {@link PluginExecution#withPlugin(au.gov.asd.tac.constellation.pluginframework.Plugin)}
     *
     ...
     * {@link PluginExecution#withParameters(au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters)}.
     * If there are currently no {@link PluginParameters} configured then a new
     * {@link PluginParameters} will be created using
     * {@link DefaultPluginParameters#getDefaultParameters(au.gov.asd.tac.constellation.pluginframework.Plugin)}.
     *
     ...
     * calling
     * {@link PluginEnvironment#executePluginLater(au.gov.asd.tac.constellation.graph.Graph, au.gov.asd.tac.constellation.pluginframework.Plugin, au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters, boolean, java.util.List, au.gov.asd.tac.constellation.pluginframework.PluginSynchronizer)}
     ...
     * calling
     * {@link PluginEnvironment#executePluginNow(au.gov.asd.tac.constellation.graph.Graph, au.gov.asd.tac.constellation.pluginframework.Plugin, au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters, boolean)}
     * on its currently configured {@link PluginEnvironment}. All parameters to
     * this call will be specified by the currently configured state of this
     * PluginExecution.
     *
     ...
     * {@link PluginEnvironment#executeEditPluginNow(au.gov.asd.tac.constellation.graph.GraphWriteMethods, au.gov.asd.tac.constellation.pluginframework.Plugin, au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters, boolean)}
     * on its currently configured {@link PluginEnvironment}. All parameters to
     * this call will be specified by the currently configured state of this
     * PluginExecution.
     *
     ...
     * {@link PluginEnvironment#executeReadPluginNow(au.gov.asd.tac.constellation.graph.GraphReadMethods, au.gov.asd.tac.constellation.pluginframework.Plugin, au.gov.asd.tac.constellation.pluginframework.parameters.PluginParameters, boolean)}
     * on its currently configured {@link PluginEnvironment}. All parameters to
     * this call will be specified by the currently configured state of this
     * PluginExecution.
     *
