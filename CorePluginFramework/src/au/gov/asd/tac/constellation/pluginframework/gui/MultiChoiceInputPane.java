 ...
 * {@link au.gov.asd.tac.constellation.pluginframework.parameters.types.MultiChoiceParameterType}.
 * <p>
 * Changing the selected items in the drop down will set the checked data for
 * the underlying {@link PluginParameter}.
 *
 * @see
 * au.gov.asd.tac.constellation.pluginframework.parameters.types.MultiChoiceParameterType
 *
