 ...
 */
@ConvertAsProperties(
        dtd = "-//au.gov.asd.tac.constellation.plugins.reporting//PluginReporter//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "PluginReporterTopComponent",
        iconBase = "au/gov/asd/tac/constellation/plugins/reporting/resources/plugin-reporter.png",
...
@ActionID(
        category = "Window",
        id = "au.gov.asd.tac.constellation.plugins.reporting.PluginReporterTopComponent"
)
@ActionReferences({
