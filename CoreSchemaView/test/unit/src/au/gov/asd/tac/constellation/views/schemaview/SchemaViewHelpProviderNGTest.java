 ...
 * @author antares
 */
public class SchemaViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class SchemaViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final SchemaViewHelpProvider instance = new SchemaViewHelpProvider();
        ...
        //but will assert they're all correctly located within the schema view package
        final String packageStart = "au.gov.asd.tac.constellation.views.schemaview.";
    ...
    /**
     * Test of getHelpTOC method, of class SchemaViewHelpProvider.
     */
    @Test
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CoreSchemaView"));
        assertTrue(tocLocation.contains("src"));
        assertTrue(tocLocation.contains("views"));
        assertTrue(tocLocation.contains("schemaview"));
        assertTrue(tocLocation.contains("schemaview-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CoreSchemaView"));
        assertTrue(tocLocation.indexOf("CoreSchemaView") < tocLocation.indexOf("src"));
        assertTrue(tocLocation.indexOf("src") < tocLocation.indexOf("views"));
        assertTrue(tocLocation.indexOf("views") < tocLocation.indexOf("schemaview"));
        assertTrue(tocLocation.indexOf("schemaview") < tocLocation.indexOf("schemaview-toc.xml"));
    }   
}
