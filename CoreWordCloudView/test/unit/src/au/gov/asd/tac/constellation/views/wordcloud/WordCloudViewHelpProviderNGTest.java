 ...
 * @author antares
 */
public class WordCloudViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class WordCloudViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final WordCloudViewHelpProvider instance = new WordCloudViewHelpProvider();
        ...
        //but will assert they're all correctly located within the word cloud package
        final String packageStart = "au.gov.asd.tac.constellation.views.wordcloud.";
    ...
    /**
     * Test of getHelpTOC method, of class WordCloudViewHelpProvider.
     */
    @Test
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CoreWordCloudView"));
        assertTrue(tocLocation.contains("src"));
        assertTrue(tocLocation.contains("views"));
        assertTrue(tocLocation.contains("wordcloud"));
        assertTrue(tocLocation.contains("word-cloud-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CoreWordCloudView"));
        assertTrue(tocLocation.indexOf("CoreWordCloudView") < tocLocation.indexOf("src"));
        assertTrue(tocLocation.indexOf("src") < tocLocation.indexOf("views"));
        assertTrue(tocLocation.indexOf("views") < tocLocation.indexOf("wordcloud"));
        assertTrue(tocLocation.indexOf("wordcloud") < tocLocation.indexOf("word-cloud-toc.xml"));
    }   
}
