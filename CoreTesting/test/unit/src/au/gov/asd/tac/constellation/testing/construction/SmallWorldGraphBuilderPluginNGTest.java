...
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.BUILD_MODE_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.K_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.NODE_TYPES_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.N_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.P_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.RANDOM_WEIGHTS_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.TRANSACTION_TYPES_PARAMETER_ID;
import static au.gov.asd.tac.constellation.testing.construction.SmallWorldGraphBuilderPlugin.T_PARAMETER_ID;
...
import au.gov.asd.tac.constellation.utilities.testing.ConstellationTest; 
 public class SmallWorldGraphBuilderPluginNGTest extends ConstellationTest {
    ...
    /**
     * Test of createParameters method, of class SmallWorldGraphBuilderPlugin.
     */
    @Test
    public void testCreateParameters() {
        ...
        assertEquals(params.getParameters().size(), 8);
        assertTrue(params.getParameters().containsKey(N_PARAMETER_ID));
        assertTrue(params.getParameters().containsKey(K_PARAMETER_ID));
        assertTrue(params.getParameters().containsKey(P_PARAMETER_ID));
        assertTrue(params.getParameters().containsKey(T_PARAMETER_ID));
        assertTrue(params.getParameters().containsKey(BUILD_MODE_PARAMETER_ID));
