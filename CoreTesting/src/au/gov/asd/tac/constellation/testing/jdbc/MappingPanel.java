...
public class MappingPanel extends javax.swing.JPanel {
     ...
     *
     * @return Null if the mappings are valid, or an informational message if not.
     */
    public String valid() {
     ...
     * <p>
     * If importing, the user should be offered all possible attributes to map to, including schema attributes as well
     * as attributes on he graph.
     *
     * @param rg A GraphReadMethods instance.
     * @param etype The GraphElementType of the required attributes.
     * @param isExporting Determines whether exporting or importing is happening.
     *
...
//        private final List<TableModelListener> listeners;
         ...
         * @param mappings A 2*n array where [0][i] is a table column and [1][i] is the graph attribute it maps to/from.
         * @param showTableColumns If true, show the table column labels by default, else show the attribute labels by
         * default.
         */
