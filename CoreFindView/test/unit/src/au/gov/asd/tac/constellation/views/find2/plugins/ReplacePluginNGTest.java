...
public class ReplacePluginNGTest {
    ...
    private BasicFindReplaceParameters parameters = new BasicFindReplaceParameters("label name", "replaced", GraphElementType.GRAPH.VERTEX, attributeList, true, false, false, false, true, false, false, false, false, false, true, false);
    private BasicFindReplaceParameters parametersReplaceNext = new BasicFindReplaceParameters("replaced", "next", GraphElementType.GRAPH.VERTEX, attributeList, true, false, false, false, true, false, false, false, false, false, true, false);
    private BasicFindReplaceParameters parametersReplaceRegEx = new BasicFindReplaceParameters("ne*", "test", GraphElementType.GRAPH.VERTEX, attributeList, false, true, false, false, true, false, false, false, false, false, true, false);
    private BasicFindReplaceParameters parametersReplaceIgnoreCase = new BasicFindReplaceParameters("lowercase", "test", GraphElementType.GRAPH.VERTEX, attributeList, true, false, true, false, true, false, false, false, false, false, true, false);
    private BasicFindReplaceParameters parametersReplaceInSelected = new BasicFindReplaceParameters("test", "replaced", GraphElementType.GRAPH.VERTEX, attributeList, true, false, false, false, true, false, false, false, true, false, true, false);
