 ...
 * @author antares
 */
public class FindViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class FindViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final FindViewHelpProvider instance = new FindViewHelpProvider();
        ...
        //but will assert they're all correctly located within the find package
        final String packageStart = "au.gov.asd.tac.constellation.views.find.";
    ...
    /**
     * Test of getHelpTOC method, of class FindViewHelpProvider.
     */
    @Test
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CoreFindView"));
        assertTrue(tocLocation.contains("src"));
        assertTrue(tocLocation.contains("views"));
        assertTrue(tocLocation.contains("find"));
        assertTrue(tocLocation.contains("find-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CoreFindView"));
        ...
        assertTrue(tocLocation.indexOf("views") < tocLocation.indexOf("find"));
        assertTrue(tocLocation.indexOf("find") < tocLocation.indexOf("find-toc.xml"));
    }   
}
