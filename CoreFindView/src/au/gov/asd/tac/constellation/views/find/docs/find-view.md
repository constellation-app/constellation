...
| Action**        | Shortcut**      |                 |                 |
+=================+=================+=================+=================+
| Open Find View  | Ctrl + F        | Edit -\> Find   | ::              |
|                 |                 |                 | : {style="text- |
|                 |                 |                 | align: center"} |
|                 |                 |                 | ![](../         |
|                 |                 |                 | resources/find. |
...
searched for, and \'matched\' on a graph. An example of a Find Window
can be seen below.
...
following types will be searched as \'strings.\' The types are as
follows:
