...
@ActionID(
        category = "Window",
        id = "au.gov.asd.tac.constellation.views.find.FindTopComponent"
)
@ActionReferences({
...
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_FindViewAction",
        preferredID = "FindViewTopComponent"
)
@NbBundle.Messages({
    "CTL_FindViewAction=Find...",
...
public final class FindViewTopComponent extends JavaFxTopComponent<FindViewPane> {
    ...
    public FindViewTopComponent() {
        setName(Bundle.CTL_FindViewTopComponent());
    ...
    protected String createStyle() {
        return JavafxStyleManager.isDarkTheme() ? "resources/find-view-dark.css" : "resources/find-view-light.css";
    }
