...
/**
 * Provider to get help pages for the find view
 *
 * @author Delphinus8821
 */
@ServiceProvider(service = HelpPageProvider.class, position = 1100)
@NbBundle.Messages("FindViewHelpProvider=Find View Help Provider")
public class FindViewHelpProvider extends HelpPageProvider {
    
    private static final String MODULE_PATH = "ext" + SEP + "docs" + SEP + "CoreFindView" + SEP;
    ...
    public Map<String, String> getHelpMap() {
        ...
        map.put("au.gov.asd.tac.constellation.views.find.FindViewTopComponent", MODULE_PATH + "find-view.md");
        return map;
    }
    ...
    public String getHelpTOC() {
        return MODULE_PATH + "find-toc.xml";
    }
}
