...
/**
 * Class responsible for managing searching for Node content from the QuickSearch
 * box.
    ...
    public void evaluate(final SearchRequest request, final SearchResponse response) {
        ...
        if (graph != null) {
            ...
            if (searchRequest.startsWith(QuickSearchUtilities.LEFT_BRACKET)) {
                ...
                if (codePos > QuickSearchUtilities.LH_SUB_BRACKET.length() && searchRequest.startsWith(QuickSearchUtilities.CIRCLED_N)) {
                    ...
                    // This is a recent search for a different category, so we can end the Node search here
                    return;
                }
            }            
            ...
            if (!matchList.isEmpty()) {
                ...
                final String displayText = QuickSearchUtilities.CIRCLED_N + "  " + QuickSearchUtilities.replaceBrackets(result.toString()) + "   " + QuickSearchUtilities.LH_SUB_BRACKET + subscriptId + QuickSearchUtilities.RH_SUB_BRACKET;
