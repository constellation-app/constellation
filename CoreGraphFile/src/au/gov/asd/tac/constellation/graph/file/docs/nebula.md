# ![Nebula](../nebula/resources/nebula.png)   Nebula
...
To create a nebula, save or copy some [.star]{.mono} files into a
directory of your choice. Then select the menu item File → New
nebula\..., which will ask you for a directory and name for a nebula
...
you can manually create a text file called [*name*.nebula]{.mono} in
that directory, where *name* can be any name you like.
...
nebula\...\". Constellation will look for star files in the same
directory as the nebula file, and open them.
...
Finally, there is always a \"Discard nebula\" option; selecting this
will close all of the graphs in the nebula, whether they have been saved
or not.
...
your favourite text editor and add a \"[colour = *colour*]{.mono}\" line
(or change the existing line). Any one of the following lines will
assign red as the nebula colour.
