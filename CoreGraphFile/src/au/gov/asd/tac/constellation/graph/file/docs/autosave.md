...
By clicking \"Setup → Options → Constellation\", the user can control
the activation of the feature and the frequency it is executed.

![autosave](resources/autosave.png){width="800" height="400"}
