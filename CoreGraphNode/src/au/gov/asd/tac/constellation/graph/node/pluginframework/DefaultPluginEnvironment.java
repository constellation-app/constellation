...
import au.gov.asd.tac.constellation.pluginframework.PluginEnvironment;
...
import au.gov.asd.tac.constellation.pluginframework.reporting.GraphReport;
import au.gov.asd.tac.constellation.pluginframework.reporting.GraphReportManager;
...
public class DefaultPluginEnvironment extends PluginEnvironment {
    ...
    public Future<?> executePluginLater(final Graph graph, final Plugin plugin, final PluginParameters parameters, final boolean interactive, final List<Future<?>> async, final PluginSynchronizer synchronizer) {
        ...
        return pluginExecutor.submit(new Callable<Object>() {
            ...
            public Object call() {
                ...
                try {
                    ConstellationLogger.getDefault().pluginStart(graph, plugin, parameters);
                } catch (Exception ex) {
                }
                ...
                try {
                    ...
                    try {
                        ConstellationLogger.getDefault().pluginStop(plugin, parameters);
                    } catch (Exception ex) {
                    }
                }
    ...
    public Object executeEditPluginNow(final GraphWriteMethods graph, final Plugin plugin, final PluginParameters parameters, final boolean interactive) throws InterruptedException, PluginException {
        ...
        try {
            ConstellationLogger.getDefault().pluginStart(GraphNode.getGraph(graph != null ? graph.getId() : null), plugin, parameters);
        } catch (Exception ex) {
        }
