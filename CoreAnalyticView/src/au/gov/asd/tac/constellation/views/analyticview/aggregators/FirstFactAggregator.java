...
public class FirstFactAggregator implements AnalyticAggregator<FactResult> {

    private static final String SCORE_NAME = "First Fact";

    @Override
    public FactResult aggregate(final List<FactResult> results) {
