...
| Action**        | Shortcut**      |                 |                 |
+=================+=================+=================+=================+
| Open Analytic   | Ctrl + Shift +  | Views -\>       | ::              |
| View            | Z               | Analytic View   | : {style="text- |
|                 |                 |                 | align: center"} |
|                 |                 |                 | !               |
|                 |                 |                 | [](../resources |
|                 |                 |                 | /analytic-view. |
...
from the \"Questions\" list. The \"Analytics\" list will be populated
with the analytics specified by that question. The alternative option is
to define your own custom question by selecting a category under the
\"Categories\" list, and then selecting any number of analytics found
the \"Analytics\" list.
