 ...
 * @author antares
 */
public class ScatterPlotHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class ScatterPlotHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final ScatterPlotHelpProvider instance = new ScatterPlotHelpProvider();
        ...
        //but will assert they're all correctly located within the scatter plot package
        final String packageStart = "au.gov.asd.tac.constellation.views.scatterplot.";
    ...
    /**
     * Test of getHelpTOC method, of class ScatterPlotHelpProvider.
     */
    @Test
