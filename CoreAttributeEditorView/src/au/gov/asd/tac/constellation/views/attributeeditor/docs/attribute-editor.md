# Attribute Editor
  ...
  **CONSTELLATION Action**   **Keyboard Shortcut**   **User Action**                                                  **Menu Icon**
  -------------------------- ----------------------- ---------------------------- -------------------------------------------------------------------------------------
  Open Attribute Editor      Ctrl + Shift + E        Views -\> Attribute Editor    ![Attribute Editor Icon](../resources/attribute_editor.png){width="16" height="16"}
...
selection\" and set the time zone. This will update the time zone for
for the selected nodes/transactions only.
...
on the \"Options\" menu at the top of the view and select \"Complete
with Schema After Edits\". With this enabled, it will run Complete with
Schema after every attribute value you edit via the Attribute Editor.
Select that same option to disable it and return to default behaviour.
