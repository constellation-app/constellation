...
import au.gov.asd.tac.constellation.views.attributeeditor.editors.BlazeEditorFactory.BlazeEditor;
...
public class BlazeEditorFactoryNGTest {
    ...
    private static final Logger LOGGER = Logger.getLogger(BlazeEditorFactoryNGTest.class.getName());
    ...
    /**
     * Test of updateControlsWithValue method, of class BlazeEditor.
     */
    @Test
    public void testUpdateControlsWithValue() {
        ...
        assertEquals(editor.getAngleText(), "");
        assertEquals(editor.getPickerColor(), Color.WHITE);
        
        editor.updateControlsWithValue(new Blaze(60, ConstellationColor.CYAN));
        
        assertEquals(editor.getAngleText(), "60");
        assertEquals(editor.getPickerColor(), Color.CYAN);
    }
    
    /**
     * Test of getValueFromControls method, of class BlazeEditor.
     * 
    ...
    public void testGetValueFromControls() throws ControlsInvalidException {
        ...
        final Blaze blaze = new Blaze(60, ConstellationColor.CYAN);
        editor.updateControlsWithValue(blaze);
        
        assertEquals(editor.getValueFromControls(), blaze);
    }
}
