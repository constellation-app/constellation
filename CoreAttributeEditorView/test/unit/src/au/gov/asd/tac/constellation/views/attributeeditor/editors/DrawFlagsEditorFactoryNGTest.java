 ...
 * @author antares
 */
public class DrawFlagsEditorFactoryNGTest {

    private static final Logger LOGGER = Logger.getLogger(DrawFlagsEditorFactoryNGTest.class.getName());
    ...
    /**
     * Test of createEditor method, of class DrawFlagsEditorFactory.
     */
    @Test
    ...
    /**
     * Test of canSet method, of class DrawFlagsEditor.
     */
    @Test
    ...
    /**
     * Test of updateControlsWithValue method, of class DrawFlagsEditor.
     */
    @Test
    public void testUpdateControlsWithValue() {
        ...
        assertEquals(editor.getValueFromControls(), new DrawFlags(false, false, false, false, false));
        
        editor.updateControlsWithValue(DrawFlags.ALL);
        
        assertEquals(editor.getValueFromControls(), new DrawFlags(true, true, true, true, true));
    }
}
