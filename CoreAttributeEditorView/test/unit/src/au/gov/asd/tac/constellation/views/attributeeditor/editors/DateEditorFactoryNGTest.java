...
public class DateEditorFactoryNGTest {
    ...
    public DateEditorFactoryNGTest() {
    }
    ...
    public void testCreateEditor() {
        ...
        final AbstractEditorFactory.AbstractEditor instance = new DateEditorFactory().createEditor(
        ...
        assertEquals(instance.getClass(), DateEditorFactory.DateEditor.class);
    }

    /**
     * Test of getAttributeType method, of class DateEditorFactory.
     */
    @Test
    public void testGetAttributeType() {
        System.out.println("getAttributeType");
        DateEditorFactory instance = new DateEditorFactory();
        String result = instance.getAttributeType();
        assertEquals(result, DateAttributeDescription.ATTRIBUTE_NAME);
    }
