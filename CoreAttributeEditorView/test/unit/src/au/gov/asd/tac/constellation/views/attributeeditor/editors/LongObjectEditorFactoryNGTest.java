...
import au.gov.asd.tac.constellation.views.attributeeditor.editors.LongObjectEditorFactory.LongObjectEditor;
 ...
 * @author antares
 */
public class LongObjectEditorFactoryNGTest {

    private static final Logger LOGGER = Logger.getLogger(LongObjectEditorFactoryNGTest.class.getName());
    ...
    /**
     * Test of createEditor method, of class LongObjectEditorFactory.
     */
    @Test
    public void testCreateEditor() {
        System.out.println("createEditor");
        
        final LongObjectEditorFactory instance = new LongObjectEditorFactory();
        ...
        assertTrue(result instanceof LongObjectEditor);
    }
    
    /**
     * Test of canSet method, of class LongObjectEditor (AbstractEditor).
     */
    @Test
    public void testCanSet() {
        ...
        final LongObjectEditorFactory instance = new LongObjectEditorFactory();
        final LongObjectEditor editor = instance.new LongObjectEditor("Test", null, ValueValidator.getAlwaysSucceedValidator(), null, null);
    ...
    /**
     * Test of updateControlsWithValue method, of class LongObjectEditor.
     */
    @Test
    public void testUpdateControlsWithValue() {
        ...
        editor.updateControlsWithValue(2L);
        
        assertEquals(editor.getNumberText(), "2");
    }
    
    /**
     * Test of getValueFromControls method, of class LongObjectEditor.
     * 
    ...
    public void testGetValueFromControls() throws ControlsInvalidException {
        ...
        final Long l = 2L;
        editor.updateControlsWithValue(l);
        
        assertEquals(editor.getValueFromControls(), l);
    }
}
