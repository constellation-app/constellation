...
public class ConnectionModeEditorFactoryNGTest {
    ...
    public ConnectionModeEditorFactoryNGTest() {
    }
    ...
    public void testCreateEditor() {
        ...
        final AbstractEditorFactory.AbstractEditor instance = new ConnectionModeEditorFactory().createEditor(
                mock(EditOperation.class),
                mock(DefaultGetter.class),
                mock(ValueValidator.class),
                "",
                mock(ConnectionMode.class));

        assertEquals(instance.getClass(), ConnectionModeEditorFactory.ConnectionModeEditor.class);
    }

    /**
     * Test of getAttributeType method, of class ConnectionModeEditorFactory.
     */
    @Test
    public void testGetAttributeType() {
        System.out.println("getAttributeType");
        ConnectionModeEditorFactory instance = new ConnectionModeEditorFactory();
