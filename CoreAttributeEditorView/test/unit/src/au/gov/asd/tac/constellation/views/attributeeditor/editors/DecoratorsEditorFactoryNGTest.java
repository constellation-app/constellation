...
public class DecoratorsEditorFactoryNGTest {
    ...
    public DecoratorsEditorFactoryNGTest() {
    }
    ...
    public void testCreateEditor() {
        ...
        final AbstractEditorFactory.AbstractEditor instance = new DecoratorsEditorFactory().createEditor(
                mock(EditOperation.class),
                mock(DefaultGetter.class),
                mock(ValueValidator.class),
                "",
                mock(VertexDecorators.class));

        assertEquals(instance.getClass(), DecoratorsEditorFactory.DecoratorsEditor.class);
    }

    /**
     * Test of getAttributeType method, of class DecoratorsEditorFactory.
     */
    @Test
    public void testGetAttributeType() {
        System.out.println("getAttributeType");
        DecoratorsEditorFactory instance = new DecoratorsEditorFactory();
