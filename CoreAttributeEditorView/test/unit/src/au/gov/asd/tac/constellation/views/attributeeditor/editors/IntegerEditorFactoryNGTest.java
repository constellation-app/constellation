...
public class IntegerEditorFactoryNGTest {
    ...
    private static final Logger LOGGER = Logger.getLogger(IntegerEditorFactoryNGTest.class.getName());
    ...
    public void testCanSet() {
        ...
        final IntegerEditorFactory instance = new IntegerEditorFactory();
        final IntegerEditor editor = instance.new IntegerEditor("Test", null, ValueValidator.getAlwaysSucceedValidator(), null, null);
