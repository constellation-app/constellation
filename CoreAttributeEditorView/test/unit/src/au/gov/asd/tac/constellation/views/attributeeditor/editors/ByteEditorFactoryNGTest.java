...
import au.gov.asd.tac.constellation.views.attributeeditor.editors.ByteEditorFactory.ByteEditor;
 ...
 * @author antares
 */
public class ByteEditorFactoryNGTest {

    private static final Logger LOGGER = Logger.getLogger(ByteEditorFactoryNGTest.class.getName());
    ...
    /**
     * Test of createEditor method, of class ByteEditorFactory.
     */
    @Test
    public void testCreateEditor() {
        ...
        assertTrue(result instanceof ByteEditor);
    }
    
    /**
     * Test of canSet method, of class ByteEditor.
     */
    @Test
    ...
    /**
     * Test of updateControlsWithValue method, of class ByteEditor.
     */
    @Test
    public void testUpdateControlsWithValue() {
        ...
        editor.updateControlsWithValue((byte) 2);
        
        assertEquals(editor.getNumberText(), "2");
    }
    
    /**
     * Test of getValueFromControls method, of class ByteEditor.
     * 
    ...
    public void testGetValueFromControls() throws ControlsInvalidException {
        ...
        final Byte b = 2;
        editor.updateControlsWithValue(b);
        
        assertEquals(editor.getValueFromControls(), b);
    }
}
