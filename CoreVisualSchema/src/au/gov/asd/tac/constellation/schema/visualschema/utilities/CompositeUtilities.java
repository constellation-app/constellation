 ...
 */
package au.gov.asd.tac.constellation.schema.visualschema.utilities;
...
import au.gov.asd.tac.constellation.schema.visualschema.attribute.objects.ContractedCompositeNodeState;
...
public class CompositeUtilities {
    ...
    public static boolean destroyAllComposites(final GraphWriteMethods graph) {
        ...
        final int compositeStateAttr = VisualConcept.VertexAttribute.COMPOSITE_STATE.get(graph);
    ...
    public static boolean contractAllComposites(final GraphWriteMethods graph) {
        ...
        final int compositeAttr = VisualConcept.VertexAttribute.COMPOSITE_STATE.get(graph);
    ...
    public static void makeComposite(final GraphWriteMethods graph, final Set<Integer> comprisingIds, final int leaderId) {
        final int compositeStateAttr = VisualConcept.VertexAttribute.COMPOSITE_STATE.ensure(graph);
        final int uniqueIdAttr = VisualConcept.TransactionAttribute.IDENTIFIER.get(graph);
