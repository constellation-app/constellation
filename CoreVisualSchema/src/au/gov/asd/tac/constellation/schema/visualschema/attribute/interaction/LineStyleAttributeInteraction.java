 ...
 */
package au.gov.asd.tac.constellation.schema.visualschema.attribute.interaction;
...
public class LineStyleAttributeInteraction extends AbstractAttributeInteraction<TransactionLineStyle> {
    ...
    public String getDisplayText(Object attrVal) {
        ...
        if (attrVal instanceof TransactionLineStyle) {
            return ((TransactionLineStyle) attrVal).name();
        } else {
    ...
    @Override
    protected Class<TransactionLineStyle> getValueType() {
        return TransactionLineStyle.class;
    }
}
