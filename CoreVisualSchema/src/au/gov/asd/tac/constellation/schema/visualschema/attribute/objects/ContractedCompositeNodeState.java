 ...
 */
package au.gov.asd.tac.constellation.schema.visualschema.attribute.objects;
...
public class ContractedCompositeNodeState {
    ...
    public List<Integer> expand(final GraphWriteMethods wg, final int vxId) {
        ...
        final int compositeStateAttr = VisualConcept.VertexAttribute.COMPOSITE_STATE.get(wg);
