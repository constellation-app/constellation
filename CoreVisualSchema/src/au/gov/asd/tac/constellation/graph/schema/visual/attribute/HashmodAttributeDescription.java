...
/**
 * A placeholder attribute type to hold a hashmod instance.
 *
 * @author CrucisGamma
 */
@ServiceProvider(service = AttributeDescription.class)
public final class HashmodAttributeDescription extends ObjectAttributeDescription {

    public static final String ATTRIBUTE_NAME = "hashmod";

    public HashmodAttributeDescription() {
