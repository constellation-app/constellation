 ...
 */
package au.gov.asd.tac.constellation.schema.analyticschema;
...
public class AnalyticSchemaFactory extends VisualSchemaFactory {
    ...
    public static final String ANALYTIC_SCHEMA_ID = "au.gov.asd.tac.constellation.schema.AnalyticSchemaFactory";
