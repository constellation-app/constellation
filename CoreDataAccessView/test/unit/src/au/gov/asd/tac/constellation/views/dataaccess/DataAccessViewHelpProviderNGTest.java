 ...
 * @author antares
 */
public class DataAccessViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class DataAccessViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final DataAccessViewHelpProvider instance = new DataAccessViewHelpProvider();
        final Map<String, String> helpMap = instance.getHelpMap();

        assertEquals(helpMap.size(), 16);
        //not going to go through and assert the existence of each specific item in the map 
        //but will assert they're all correctly located within the data access package
        final String packageStart = "au.gov.asd.tac.constellation.views.dataaccess.";
    ...
    /**
     * Test of getHelpTOC method, of class DataAccessViewHelpProvider.
     */
    @Test
