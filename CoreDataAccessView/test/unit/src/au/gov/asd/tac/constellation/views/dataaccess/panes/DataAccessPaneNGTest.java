...
public class DataAccessPaneNGTest {
    ...
    public void setUpMethod() throws Exception {
        ...
        /**
         * I suspect this doesn't work because the action handler is initialized during the constructor and the spy is
         * not applied until after the construction is complete.
         */
        @Test(enabled = false)
