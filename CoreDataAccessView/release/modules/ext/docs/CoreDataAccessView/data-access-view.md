...
<td style="text-align: center;"><img src="../ext/docs/CoreDataAccessView/resources/data-access-view.png" alt="Data Access View Icon" /></td>
</tr>
</tbody>
</table>
...
<img src="../ext/docs/CoreDataAccessView/resources/DataAccessView.png" alt="Data Access
View" />
...
At the very top, there is a list of tabs. Pressing the <img src="../ext/docs/CoreDataAccessView/resources/DataAccessAdd.png" alt="Add
Icon" />
...
when ready, pressing the <img src="../ext/docs/CoreDataAccessView/resources/DataAccessGo.png" alt="Go
Icon" />
...
Refer to the [Global
Parameters](../ext/docs/CoreDataAccessView/datetime-range.md)
...
![Favourite
Icon](../ext/docs/CoreDataAccessView/resources/DataAccessFavourite.png)
...
Refer to the
[Options](../ext/docs/CoreDataAccessView/data-access-options.md)
page for more details on the Workflow Options menu.

## Configuring Data Access Categories

Refer to the
[Preferences](../ext/docs/CoreDataAccessView/data-access-view-preferences.md)
