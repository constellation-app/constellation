# Quality Control View
  ...
  **CONSTELLATION Action**               **Keyboard Shortcut**                 **User Action**                                                          **Menu Icon**
  -------------------------------------- ------------------------------------- -------------------------------- ---------------------------------------------------------------------------------------------
  Open Quality Control View              Keyboard Shortcut: Ctrl + Shift + Q   Views -\> Quality Control View    ![Quality Control View Icon](../resources/quality-control-view.png){width="16" height="16"}
