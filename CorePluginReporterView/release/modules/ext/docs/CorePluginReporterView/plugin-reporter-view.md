...
<td style="text-align: center"><img src="../ext/docs/CorePluginReporterView/resources/plugin-reporter.png" alt="Plugin Reporter Icon" /></td>
</tr>
</tbody>
</table>
...
<img src="../ext/docs/CorePluginReporterView/resources/PluginReporter.png" alt="Plugin
Reporter" />
...
-   Green indicates the plugin is currently running.
    ...
    <img src="../ext/docs/CorePluginReporterView/resources/PluginReportGreen.png" alt="Running Plugin
    Report" />
...
-   Blue indicates that the plugin was cancelled.
    ...
    <img src="../ext/docs/CorePluginReporterView/resources/PluginReportBlue.png" alt="Cancelled Plugin
    Report" />
...
-   Orange indicates that an anticipated error occurred.
    ...
    <img src="../ext/docs/CorePluginReporterView/resources/PluginReportOrange.png" alt="Anticipated Error Plugin
    Report" />
...
-   Red indicates that an unexpected error occurred.
    ...
    <img src="../ext/docs/CorePluginReporterView/resources/PluginReportRed.png" alt="Unexpected Error Plugin
    Report" />
...
-   Grey indicates that the plugin finished successfully.
    ...
    <img src="../ext/docs/CorePluginReporterView/resources/PluginReportGrey.png" alt="Successful Plugin
    Report" />
