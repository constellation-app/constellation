 ...
 * @author antares
 */
public class PluginReporterHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class PluginReporterHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final PluginReporterHelpProvider instance = new PluginReporterHelpProvider();
        ...
        final String packageStart = "au.gov.asd.tac.constellation.views.pluginreporter.";
    ...
    /**
     * Test of getHelpTOC method, of class PluginReporterHelpProvider.
     */
    @Test
