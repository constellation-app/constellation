 ...
 * @author antares
 */
public class CoreHelpHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class CoreHelpHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final CoreHelpHelpProvider instance = new CoreHelpHelpProvider();
        ...
        //but will assert they're all correctly located within the help package
        final String packageStart = "au.gov.asd.tac.constellation.help.";
    ...
    /**
     * Test of getHelpTOC method, of class CoreHelpHelpProvider.
     */
    @Test
