...
public class TOCGenerator {
    ...
    public static boolean createTOCFile(final String filePath) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Path to Table of Contents file was invalid: " + filePath, ex);
        }
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Unable to create table of contents file. FilePath: " + filePath, ex);
            success = false;
        }
        return success;
