...
@ActionRegistration(displayName = "#CTL_DeselectAllAction", iconBase = "au/gov/asd/tac/constellation/functionality/select/resources/deselect_all.png", surviveFocusChange = true)
@ActionReferences({
...
public final class DeselectAllAction extends SimplePluginAction {
    ...
    public DeselectAllAction(final GraphNode context) {
        super(context, CorePluginRegistry.DESELECT_ALL);
    }
}
