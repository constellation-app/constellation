...
@ActionRegistration(displayName = "#CTL_SelectOneHopInducedSubgraphAction", iconBase = "au/gov/asd/tac/constellation/functionality/select/structure/resources/one_hop_induced_subgraph.png", surviveFocusChange = true)
@ActionReferences({
...
public class SelectOneHopInducedSubgraphAction extends SimplePluginAction {
    ...
    public SelectOneHopInducedSubgraphAction(final GraphNode context) {
        super(context, CorePluginRegistry.SELECT_INDUCED_ONE_HOP);
    }
