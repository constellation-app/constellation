 ...
 */
@ConvertAsProperties(
        dtd = "-//au.gov.asd.tac.constellation.functionality.perspectives//PerspectiveBookmark//EN",
        autostore = false
)
...
@ActionID(
        category = "Window",
        id = "au.gov.asd.tac.constellation.functionality.perspectives.PerspectiveBookmarkTopComponent"
)
@ActionReferences({
