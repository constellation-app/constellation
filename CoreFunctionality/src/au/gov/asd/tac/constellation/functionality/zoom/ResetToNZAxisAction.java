...
@ActionRegistration(displayName = "#CTL_ResetToNZAxisAction", iconBase = "au/gov/asd/tac/constellation/functionality/zoom/axis_z_negative.png", surviveFocusChange = true)
@ActionReferences({
