 ...
 */
@ConvertAsProperties(
        dtd = "-//au.gov.asd.tac.constellation.functionality.select.named//NamedSelection//EN",
        autostore = false)
...
@ActionID(
        category = "Window",
        id = "au.gov.asd.tac.constellation.functionality.select.named.NamedSelectionTopComponent")
@ActionReferences({
