...
@ActionRegistration(displayName = "#CTL_AddCustomBlazeAction", iconBase = "au/gov/asd/tac/constellation/functionality/blaze/addblaze_custom.png", surviveFocusChange = true)
@ActionReferences({
