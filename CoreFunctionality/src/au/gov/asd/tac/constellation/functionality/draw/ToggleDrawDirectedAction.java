 ...
 */
package au.gov.asd.tac.constellation.functionality.draw;
...
public final class ToggleDrawDirectedAction extends AbstractAction implements Presenter.Toolbar {
    ...
    public ToggleDrawDirectedAction(final GraphNode context, final ButtonGroup buttonGroup) {
        ...
        try {
            ...
            drawDirected = drawDirectedAttribute != Graph.NOT_FOUND ? rg.getBooleanValue(drawDirectedAttribute, 0) : VisualDefaults.DEFAULT_DRAWING_DIRECTED_TRANSACTIONS;
        } finally {
            rg.release();
        }
        putValue(
    ...
    public void actionPerformed(final ActionEvent ev) {
        PluginExecution.withPlugin(CorePluginRegistry.TOGGLE_DRAW_DIRECTED)
