...
@ActionRegistration(displayName = "#CTL_DeselectTransactionsAction", iconBase = "au/gov/asd/tac/constellation/functionality/select/resources/deselect_all.png", surviveFocusChange = true)
@ActionReferences({
...
public final class DeselectTransactionsAction extends SimplePluginAction {
    ...
    public DeselectTransactionsAction(final GraphNode context) {
        super(context, CorePluginRegistry.DESELECT_TRANSACTIONS);
    }
}
