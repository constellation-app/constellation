...
@ActionRegistration(displayName = "#CTL_SelectSourcesAction", iconBase = "au/gov/asd/tac/constellation/functionality/select/structure/resources/source.png", surviveFocusChange = true)
@ActionReferences({
...
public class SelectSourcesAction extends SimplePluginAction {
    ...
    public SelectSourcesAction(final GraphNode context) {
        super(context, CorePluginRegistry.SELECT_SOURCES);
    }
}
