...
@ActionRegistration(displayName = "#CTL_SelectSourcesAction", iconBase = "au/gov/asd/tac/constellation/functionality/select/structure/source.png", surviveFocusChange = true)
@ActionReferences({
