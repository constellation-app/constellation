    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        switch (command) {
            case DIM_SELECTED_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.DIM_SELECTED).executeLater(graph);
                break;
            case DIM_UNSELECTED_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.DIM_UNSELECTED).executeLater(graph);
                break;
            case DIM_ALL_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.DIM_ALL).executeLater(graph);
                break;
            case UNDIM_SELECTED_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.UNDIM_SELECTED).executeLater(graph);
                break;
            case UNDIM_UNSELECTED_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.UNDIM_UNSELECTED).executeLater(graph);
                break;
            case UNDIM_ALL_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.UNDIM_ALL).executeLater(graph);
                break;
            case SELECT_DIMMED_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.SELECT_DIMMED).executeLater(graph);
                break;
            case SELECT_UNDIMMED_ACTION:
                PluginExecution.withPlugin(CorePluginRegistry.SELECT_UNDIMMED).executeLater(graph);
                break;
        }
    }
