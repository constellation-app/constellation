...
@ActionRegistration(displayName = "#CTL_ResetToZAxisAction", iconBase = "au/gov/asd/tac/constellation/functionality/zoom/resources/axis_z.png", surviveFocusChange = true)
@ActionReferences({
