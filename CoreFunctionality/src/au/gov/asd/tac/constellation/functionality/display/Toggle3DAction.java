...
public final class Toggle3DAction extends AbstractAction implements Presenter.Toolbar {
    ...
    public Toggle3DAction(final GraphNode context, final ButtonGroup buttonGroup) {
        ...
        try {
            ...
            isDisplayMode3D = displayMode3DAttribute != Graph.NOT_FOUND ? rg.getBooleanValue(displayMode3DAttribute, 0) : VisualDefaults.DEFAULT_DISPLAY_MODE_3D;
        } finally {
            rg.release();
        }
        putValue(
    ...
    public void actionPerformed(final ActionEvent ev) {
        PluginExecution.withPlugin(CorePluginRegistry.TOGGLE_DISPLAY_MODE)
