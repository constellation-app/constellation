 ...
 */
package au.gov.asd.tac.constellation.functionality.statusline;
...
@Messages({
    ...
    "CTL_ex=Edges",
    "CTL_tx=Transactions",})
public final class GraphStatus implements StatusLineElementProvider, LookupListener, GraphChangeListener {
