...
@ActionRegistration(displayName = "#CTL_CopyToNewGraphAction", iconBase = "au/gov/asd/tac/constellation/functionality/copypaste/resources/copy_to_new_graph.png", surviveFocusChange = true)
@ActionReferences({
...
public final class CopyToNewGraphAction extends SimplePluginAction {
    ...
    public CopyToNewGraphAction(final GraphNode context) {
        super(context, CorePluginRegistry.COPY_TO_NEW_GRAPH);
    }
}
