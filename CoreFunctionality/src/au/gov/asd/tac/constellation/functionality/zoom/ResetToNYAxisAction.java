...
@ActionRegistration(displayName = "#CTL_ResetToNYAxisAction", iconBase = "au/gov/asd/tac/constellation/functionality/zoom/axis_y_negative.png", surviveFocusChange = true)
@ActionReferences({
