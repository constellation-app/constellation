...
@ActionRegistration(displayName = "#CTL_ResetToNYAxisAction", iconBase = "au/gov/asd/tac/constellation/functionality/zoom/resources/axis_y_negative.png", surviveFocusChange = true)
@ActionReferences({
