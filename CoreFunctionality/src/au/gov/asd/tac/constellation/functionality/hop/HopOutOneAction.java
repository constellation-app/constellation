 ...
 */
package au.gov.asd.tac.constellation.functionality.hop;
...
@ActionRegistration(displayName = "#CTL_HopOutOneAction", iconBase = "au/gov/asd/tac/constellation/functionality/hop/resources/hop_one.png", surviveFocusChange = true)
@ActionReferences({
...
public final class HopOutOneAction extends AbstractAction {
    ...
    public void actionPerformed(final ActionEvent e) {
        PluginExecution.withPlugin(CorePluginRegistry.HOP_OUT)
