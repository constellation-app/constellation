...
public final class ToggleSelectionModeAction extends AbstractAction implements Presenter.Toolbar {
    ...
    public ToggleSelectionModeAction(final GraphNode context, final ButtonGroup buttonGroup) {
        ...
        try {
            ...
            drawingMode = drawingModeAttribute != Graph.NOT_FOUND ? rg.getBooleanValue(drawingModeAttribute, 0) : VisualDefaults.DEFAULT_DRAWING_MODE;
        } finally {
            rg.release();
        }
        putValue(
    ...
    public void actionPerformed(final ActionEvent ev) {
        PluginExecution.withPlugin(CorePluginRegistry.TOGGLE_SELECTION_MODE)
