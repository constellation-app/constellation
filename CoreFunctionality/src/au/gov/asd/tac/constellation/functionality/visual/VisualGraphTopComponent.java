...
import au.gov.asd.tac.constellation.functionality.CloseAction;
import au.gov.asd.tac.constellation.functionality.composite.ContractAllCompositesAction;
import au.gov.asd.tac.constellation.functionality.composite.ExpandAllCompositesAction;
import au.gov.asd.tac.constellation.functionality.copypaste.CopyToClipboardAction;
import au.gov.asd.tac.constellation.functionality.copypaste.CutToClipboardAction;
import au.gov.asd.tac.constellation.functionality.copypaste.PasteFromClipboardAction;
import au.gov.asd.tac.constellation.functionality.display.DrawBlazesAction;
import au.gov.asd.tac.constellation.functionality.display.DrawConnectionLabelsAction;
import au.gov.asd.tac.constellation.functionality.display.DrawConnectionsAction;
import au.gov.asd.tac.constellation.functionality.display.DrawEdgesAction;
import au.gov.asd.tac.constellation.functionality.display.DrawLinksAction;
import au.gov.asd.tac.constellation.functionality.display.DrawNodeLabelsAction;
import au.gov.asd.tac.constellation.functionality.display.DrawNodesAction;
import au.gov.asd.tac.constellation.functionality.display.DrawTransactionsAction;
import au.gov.asd.tac.constellation.functionality.display.Toggle3DAction;
import au.gov.asd.tac.constellation.functionality.display.ToggleGraphVisibilityAction;
import au.gov.asd.tac.constellation.functionality.draw.ToggleDrawDirectedAction;
import au.gov.asd.tac.constellation.functionality.draw.ToggleSelectionModeAction;
import au.gov.asd.tac.constellation.functionality.save.SaveAsAction;
...
@ActionID(
        category = "Window",
        id = "au.gov.asd.tac.constellation.functionality.visual.VisualGraphTopComponent"
)
@ActionReferences({
...
public final class VisualGraphTopComponent extends CloneableTopComponent implements GraphChangeListener, UndoRedo.Provider {
    ...
    private void visualUpdate() {
        ...
        try {
            ...
            drawFlags = drawFlagsAttribute != Graph.NOT_FOUND ? rg.getObjectValue(drawFlagsAttribute, 0) : VisualDefaults.DEFAULT_DRAW_FLAGS;
            visibleAboveThreshold = visibleAboveThresholdAttribute != Graph.NOT_FOUND ? rg.getBooleanValue(visibleAboveThresholdAttribute, 0) : VisualDefaults.DEFAULT_GRAPH_VISIBILITY;
