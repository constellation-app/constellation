...
public class DimAllTransactionsNodesNGTest {
    ...
    public void dimAllTest() throws InterruptedException, PluginException {
        ...
        PluginExecution.withPlugin(CorePluginRegistry.DIM_ALL).executeNow(graph);
    ...
    public void dimAllTransactionsTest() throws InterruptedException, PluginException {
        ...
        PluginExecution.withPlugin(CorePluginRegistry.SELECT_ALL).executeNow(graph);
        PluginExecution.withPlugin(CorePluginRegistry.DESELECT_VERTICES).executeNow(graph);
        PluginExecution.withPlugin(CorePluginRegistry.DIM_SELECTED).executeNow(graph);
    ...
    public void dimAllNodesTest() throws InterruptedException, PluginException {
        ...
        PluginExecution.withPlugin(CorePluginRegistry.SELECT_ALL).executeNow(graph);
        PluginExecution.withPlugin(CorePluginRegistry.DESELECT_VERTICES).executeNow(graph);
        PluginExecution.withPlugin(CorePluginRegistry.DIM_UNSELECTED).executeNow(graph);
    ...
    public void undimAllTest() throws InterruptedException, PluginException {
        ...
        PluginExecution.withPlugin(CorePluginRegistry.UNDIM_ALL).executeNow(graph);
