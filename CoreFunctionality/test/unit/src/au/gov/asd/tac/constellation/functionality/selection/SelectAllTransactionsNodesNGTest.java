 ...
 * @author altair
 */
public class SelectAllTransactionsNodesNGTest {
    ...
    public SelectAllTransactionsNodesNGTest() {
    }
    ...
    public void selectAllNodesTest() throws InterruptedException, PluginException {
        ...
        PluginExecution.withPlugin(CorePluginRegistry.SELECT_ALL).executeNow(graph);
        PluginExecution.withPlugin(CorePluginRegistry.DESELECT_TRANSACTIONS).executeNow(graph);
