 ...
 * @author antares
 */
public class FunctionalityHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class FunctionalityHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final FunctionalityHelpProvider instance = new FunctionalityHelpProvider();
        ...
        //but will assert they're all correctly located within the functionality package
        final String packageStart = "au.gov.asd.tac.constellation.functionality.";
    ...
    /**
     * Test of getHelpTOC method, of class FunctionalityHelpProvider.
     */
    @Test
