 ...
 * @author antares
 */
public class HistogramViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class HistogramViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final HistogramViewHelpProvider instance = new HistogramViewHelpProvider();
        ...
        //but will assert they're all correctly located within the histogram package
        final String packageStart = "au.gov.asd.tac.constellation.views.histogram.";
    ...
    /**
     * Test of getHelpTOC method, of class HistogramViewHelpProvider.
     */
    @Test
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CoreHistogramView"));
        assertTrue(tocLocation.contains("src"));
        assertTrue(tocLocation.contains("views"));
        assertTrue(tocLocation.contains("histogram"));
        assertTrue(tocLocation.contains("histogram-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CoreHistogramView"));
        assertTrue(tocLocation.indexOf("CoreHistogramView") < tocLocation.indexOf("src"));
        assertTrue(tocLocation.indexOf("src") < tocLocation.indexOf("views"));
        assertTrue(tocLocation.indexOf("views") < tocLocation.indexOf("histogram"));
        assertTrue(tocLocation.indexOf("histogram") < tocLocation.indexOf("histogram-toc.xml"));
    }   
}
