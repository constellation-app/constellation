 ...
 * @author Quasar985
 */
public class ScriptFormatterNGTest {
    ...
    /**
     * Test of createParameters method, of class ScriptFormatter.
     */
    @Test
    public void testCreateParameters() {
        System.out.println("createParameters");
        final ScriptFormatter instance = new ScriptFormatter();
        final String expResult = "";

        final PluginParameters result = instance.createParameters();
        assertEquals(result.getParameters().get(ScriptFormatter.SCRIPT_PARAMETER_ID).getStringValue(), expResult);
    }

    /**
     * Test of createBin method, of class ScriptFormatter.
     */
    @Test
    public void testCreateBin() {
        ...
        when(mockParameters.get(ScriptFormatter.SCRIPT_PARAMETER_ID)).thenReturn(mockParam);
        ...
        verify(mockParameters).get(ScriptFormatter.SCRIPT_PARAMETER_ID);
