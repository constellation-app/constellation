...
/**
 * A DestinationVertexRepresentative implements an ElementRepresentative that
 * allows a connection type graph element to be represented by attributes and
 * properties of its destination vertex.
 *
 * @author sirius
 */
public class DestinationVertexRepresentative extends ElementRepresentative {
    ...
    public int findRepresentative(GraphReadMethods graph, GraphElementType elementType, int element) {
        return elementType.getDestinationVertex(graph, element);
    }
