...
/**
 * A bin that holds double values representing the minimum of all neighbour
 * values adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexMinNeighbourDoubleAttributeBin extends DoubleBin {
    ...
    @Override
    public Bin create() {
        return new VertexMinNeighbourDoubleAttributeBin();
    }
}
