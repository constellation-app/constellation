...
/**
 * A bin that holds float values representing the average of all neighbour
 * values adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexAverageNeighbourFloatAttributeBin extends FloatBin {
    ...
    @Override
    public Bin create() {
        return new VertexAverageNeighbourFloatAttributeBin();
    }
}
