...
| Action**        | Shortcut**      |                 |                 |
+=================+=================+=================+=================+
| Open Histogram  | Ctrl + Shift +  | Views -\>       | ::              |
| View            | H               | Histogram       | : {style="text- |
|                 |                 |                 | align: center"} |
|                 |                 |                 | ![](../resou    |
|                 |                 |                 | rces/histogram. |
|                 |                 |                 | png){width="16" |
...
-   *Within Existing Selection* - Clicking rows will not change the
    ...
    elements. Holding the shift key while left clicking will change red
    elements of rows to yellow. Holding the ctrl key while left clicking
    will toggle elements of rows between red and yellow. ![Within
    Existing Selection example](resources/Histogram-Within.png)
