 ...
 * @author sirius
 */
public class VertexMinTransactionDatetimeAttributeBin extends DateTimeBin {

    public VertexMinTransactionDatetimeAttributeBin() {
    }

    public VertexMinTransactionDatetimeAttributeBin(DateTimeFormatter formatter) {
        super(formatter);
    }
    ...
    @Override
    public Bin create() {
        return new VertexMinTransactionDatetimeAttributeBin(formatter);
    }
}
