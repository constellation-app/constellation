 ...
 */
package au.gov.asd.tac.constellation.arrangements.circle;
 ...
 * @author algol
 */
@ActionID(category = "Arrange", id = "au.gov.asd.tac.constellation.arrangements.circle.ArrangeInCirclesAction")
...
public final class ArrangeInCirclesAction extends AbstractAction {
    ...
    public void actionPerformed(final ActionEvent e) {
        PluginExecutor.startWith(ArrangementPluginRegistry.CIRCLES).followedBy(CorePluginRegistry.RESET)
