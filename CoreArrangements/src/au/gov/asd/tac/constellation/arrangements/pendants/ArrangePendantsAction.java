 ...
 */
package au.gov.asd.tac.constellation.arrangements.pendants;
 ...
 * @author algol
 */
@ActionID(category = "Arrange", id = "au.gov.asd.tac.constellation.arrangements.pendants.ArrangePendantsAction")
