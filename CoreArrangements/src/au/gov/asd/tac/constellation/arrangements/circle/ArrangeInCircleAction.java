 ...
 * @author algol
 */
@ActionID(category = "Arrange", id = "au.gov.asd.tac.constellation.arrangements.circle.ArrangeInCircleAction")
...
public final class ArrangeInCircleAction extends AbstractAction {
    ...
    public void actionPerformed(final ActionEvent e) {
        PluginExecutor.startWith(ArrangementPluginRegistry.CIRCLE).followedBy(CorePluginRegistry.RESET)
