...
import au.gov.asd.tac.constellation.arrangements.utilities.SelectNamedSelectionPanel;
import au.gov.asd.tac.constellation.functionality.CorePluginRegistry;
import au.gov.asd.tac.constellation.functionality.select.named.NamedSelectionState;
        ...
        try {
            ...
            if (namedSelectionId != Graph.NOT_FOUND) {
                ...
                if (namedSelectionStateId != Graph.NOT_FOUND) {
                    ...
                    dd.setHelpCtx(new HelpCtx("au.gov.asd.tac.constellation.arrangements.hierarchical.HierarchicalAction"));
