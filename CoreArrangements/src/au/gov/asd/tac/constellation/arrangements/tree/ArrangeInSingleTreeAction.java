...
import au.gov.asd.tac.constellation.arrangements.GraphTaxonomy;
...
import au.gov.asd.tac.constellation.graph.node.pluginframework.SimpleAction;
 ...
 */
@ActionID(category = "Arrange", id = "au.gov.asd.tac.constellation.arrangements.tree.ArrangeInSingleTreeAction")
...
public final class ArrangeInSingleTreeAction extends SimpleAction {
    ...
    protected void edit(final PluginGraphs graphs, final PluginInteraction interaction, final PluginParameters parameters) throws InterruptedException, PluginException {
        ...
        try {
            ...
            PluginExecution.withPlugin(CorePluginRegistry.RESET).executeNow(graphs.getGraph());
        } finally {
            wg.commit();
        }
    }
