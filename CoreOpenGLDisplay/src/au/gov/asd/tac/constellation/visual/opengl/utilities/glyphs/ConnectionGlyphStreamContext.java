...
public class ConnectionGlyphStreamContext extends GlyphStreamContext {
    ...
    public ConnectionGlyphStreamContext(final int totalScale, final float visibility, final int labelNumber) {
        super(totalScale, visibility, labelNumber);
    }

    public ConnectionGlyphStreamContext(final ConnectionGlyphStreamContext context) {
