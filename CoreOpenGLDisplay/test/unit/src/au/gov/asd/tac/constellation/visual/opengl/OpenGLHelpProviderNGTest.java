 ...
 * @author antares
 */
public class OpenGLHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class OpenGLHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final OpenGLHelpProvider instance = new OpenGLHelpProvider();
        ...
        //but will assert they're all correctly located within the opengl package
        final String packageStart = "au.gov.asd.tac.constellation.visual.opengl.";
    ...
    /**
     * Test of getHelpTOC method, of class OpenGLHelpProvider.
     */
    @Test
