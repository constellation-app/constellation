 ...
 * @author antares
 */
public class SecurityHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class SecurityHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final SecurityHelpProvider instance = new SecurityHelpProvider();
        ...
        //but will assert they're all correctly located within the security package
        final String packageStart = "au.gov.asd.tac.constellation.security.";
    ...
    /**
     * Test of getHelpTOC method, of class SecurityHelpProvider.
     */
    @Test
