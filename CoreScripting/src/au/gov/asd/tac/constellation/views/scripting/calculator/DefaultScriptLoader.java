...
import static au.gov.asd.tac.constellation.views.scripting.calculator.ScriptIO.decode;
...
public class DefaultScriptLoader extends AbstractScriptLoader {
    ...
    public Map<String, String[]> getScripts() {
        ...
        try {
            InputStream is = ScriptIO.class.getResourceAsStream("resources/DefaultScripts/DefaultScriptList.txt");
        ...
        for (String name : defaultNames) {
            ...
            try {
                final BufferedReader r = new BufferedReader(new InputStreamReader(ScriptIO.class.getResourceAsStream("resources/DefaultScripts/" + name), StandardCharsets.UTF_8.name()));
