...
public class PreferencesHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class PreferencesHelpProvider.
     */
    @Test
    ...
    /**
     * Test of getHelpTOC method, of class PreferencesHelpProvider.
     */
    @Test
    public void testGetHelpTOC() {
        ...
        assertTrue(tocLocation.contains("CorePreferences"));
        assertTrue(tocLocation.contains("src"));
        assertTrue(tocLocation.contains("preferences"));
        assertTrue(tocLocation.contains("preferences-toc.xml"));

        assertTrue(tocLocation.indexOf("docs") < tocLocation.indexOf("CorePreferences"));
        assertTrue(tocLocation.indexOf("CorePreferences") < tocLocation.indexOf("src"));
        assertTrue(tocLocation.indexOf("src") < tocLocation.indexOf("preferences"));
        assertTrue(tocLocation.indexOf("preferences") < tocLocation.indexOf("preferences-toc.xml"));
    }   
}
