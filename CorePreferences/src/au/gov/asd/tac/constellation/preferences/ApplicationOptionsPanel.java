...
final class ApplicationOptionsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        restWarningText = new JLabel();
        restWarningText.setVisible(false);
        ...
        restDirectoryText.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent evt) {
                restDirectoryTextKeyTyped(evt);
            }
        });
        ...
        restWarningText.setForeground(new Color(255, 0, 0));
        Mnemonics.setLocalizedText(restWarningText, NbBundle.getMessage(ApplicationOptionsPanel.class, "ApplicationOptionsPanel.restWarningText.text")); // NOI18N
