...
public final class ApplicationOptionsPanelController extends OptionsPanelController {
    ...
    public void update() {
        ...
        applicationOptionsPanel.setRememberOpenSaveLocation(prefs.getBoolean(ApplicationPreferenceKeys.REMEMBER_SAVE_LOCATION, ApplicationPreferenceKeys.REMEMBER_SAVE_LOCATION_DEFAULT));
    }
    ...
    public void applyChanges() {
        if (isValid()) {
            ...
            if (isChanged()) {
                ...
                prefs.putBoolean(ApplicationPreferenceKeys.REMEMBER_SAVE_LOCATION, applicationOptionsPanel.getRememberOpenSaveLocation());
            }
        }
    }
    ...
    public boolean isChanged() {
        ...
        return !(applicationOptionsPanel.getUserDirectory().equals(prefs.get(ApplicationPreferenceKeys.USER_DIR, ApplicationPreferenceKeys.USER_DIR_DEFAULT))
                ...
                && applicationOptionsPanel.getRememberOpenSaveLocation() == prefs.getBoolean(ApplicationPreferenceKeys.REMEMBER_SAVE_LOCATION, ApplicationPreferenceKeys.REMEMBER_SAVE_LOCATION_DEFAULT));
    }
