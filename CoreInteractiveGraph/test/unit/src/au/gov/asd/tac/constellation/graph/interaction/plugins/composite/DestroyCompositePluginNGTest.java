 ...
 * @author antares
 */
public class DestroyCompositePluginNGTest {
    ...
    /**
     * Test of getItems method, of class DestroyCompositePlugin.
     */
    @Test
    public void testGetItems() {
        System.out.println("getItems");
        
        final DestroyCompositePlugin instance = new DestroyCompositePlugin();
        
        final List<String> result1 = instance.getItems(graph, GraphElementType.VERTEX, vxId1);
        assertEquals(result1.size(), 1);
        assertEquals(result1.get(0), "Destroy Composite");
