...
import static au.gov.asd.tac.constellation.graph.interaction.plugins.display.SetDrawFlagPlugin.FLAG_PARAMETER_ID;
 ...
 * @author antares
 */
public class SetDrawFlagPluginNGTest {
    ...
    /**
     * Test of createParameters method, of class SetDrawFlagPlugin.
     */
    @Test
    public void testCreateParameters() {
        System.out.println("createParameters");
        
        final SetDrawFlagPlugin instance = new SetDrawFlagPlugin();
    ...
    /**
     * Test of edit method, of class SetDrawFlagPlugin.
     * 
    ...
    public void testEdit() throws InterruptedException, PluginException {
        ...
        assertEquals(graph.getIntValue(drawFlagsAttribute, 0), 16);
    }
}
