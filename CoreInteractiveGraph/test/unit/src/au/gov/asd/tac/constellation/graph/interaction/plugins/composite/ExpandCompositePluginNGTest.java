 ...
 * @author antares
 */
public class ExpandCompositePluginNGTest {
    ...
    /**
     * Test of getItems method, of class ExpandCompositePlugin.
     */
    @Test
    public void testGetItems() {
        System.out.println("getItems");
        
        final ExpandCompositePlugin instance = new ExpandCompositePlugin();
        
        // vxId1 is a contracted composite so this should give the option to expand
        final List<String> result1 = instance.getItems(graph, GraphElementType.VERTEX, vxId1);
        assertEquals(result1.size(), 1);
        assertEquals(result1.get(0), "Expand Composite");
        ...
        // vxId3 is already an expanded composite so no options should be presented
