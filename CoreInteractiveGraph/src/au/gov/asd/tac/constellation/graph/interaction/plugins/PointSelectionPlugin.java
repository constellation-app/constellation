...
public final class PointSelectionPlugin extends SimpleEditPlugin {
    ...
    public void edit(final GraphWriteMethods graph, final PluginInteraction interaction, final PluginParameters parameters) throws InterruptedException {
        ...
        final int maxTransactionsDrawn = maxTransactionsAttribute != Graph.NOT_FOUND ? graph.getIntValue(maxTransactionsAttribute, 0) : VisualDefaults.DEFAULT_MAX_TRANSACTION_TO_DRAW;
