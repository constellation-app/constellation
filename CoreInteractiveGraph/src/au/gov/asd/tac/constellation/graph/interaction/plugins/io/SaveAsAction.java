        ...
        if (!inst.isEmpty()) {
            ...
            FileChooser.openSaveDialog(fileChooser).thenAccept(optionalFile -> optionalFile.ifPresent(selectedFile -> {
                ...
                try {
                    ...
                    LOGGER.log(Level.SEVERE, ex.getLocalizedMessage(), Bundle.MSG_SaveAsFailed(selectedFile.getName(), ex.getLocalizedMessage()));
//                    LOGGER.log(Level.SEVERE, Bundle.MSG_SaveAsFailed(selectedFile.getName(), ex.getLocalizedMessage()), ex);
                }
