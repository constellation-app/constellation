 ...
 */
@ServiceProviders({
    @ServiceProvider(service = GraphContextMenuProvider.class, position = 500),
...
public class ExpandCompositePlugin extends SimpleEditPlugin implements GraphContextMenuProvider {
