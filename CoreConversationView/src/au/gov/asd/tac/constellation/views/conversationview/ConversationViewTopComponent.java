...
/**
 * Top component which displays the Conversation View. The conversation view displays content on nodes and transactions
 * in the graph in a chat style window.
 *
 * @see Conversation
 * @see ConversationBox
 */
