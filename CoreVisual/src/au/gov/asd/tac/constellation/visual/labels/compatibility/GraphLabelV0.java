...
public final class GraphLabelV0 implements Serializable {
     ...
     */
    public GraphLabelV0(final String attributeName, final ConstellationColor color, final float size) {
     ...
     */
    public GraphLabelV0(final GraphLabelV0 label) {
    ...
    public static GraphLabelV0 valueOf(final String graphLabelString) {
        ...
        if (labelProperties.size() == 3) {
            ...
            return new GraphLabelV0(attributeName, color, size);
        }
