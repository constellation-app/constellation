 ...
 */
package au.gov.asd.tac.constellation.visual.display;
 ...
 * @author algol
 */
public final class VisualDefaults {

    private VisualDefaults() {
    }
     ...
     */
    public static final Decorators DEFAULT_DECORATORS = Decorators.NO_DECORATORS;
