 ...
 */
package au.gov.asd.tac.constellation.visual.graphics3d;
 ...
 */
/**
 * Resizable-array implementation of float[]. This uses less storage than an
 * ArrayList&lt;Float&gt;.
 *
...
//            float[] oldData = elementData;
     ...
     */
    public void ensureSize(final int size, final float value) {
        if (this.size < size) {
            modCount++;
     ...
     *
     * @param e0 the first element to be appended to this list
     * @param e1 the second element to be appended to this list
     * @param e2 the third element to be appended to this list
     *
     * @return <tt>true</tt> (as specified by {@link Collection#add})
     */
    public boolean add(final float e0, final float e1, final float e2) {
        ensureCapacity(size + 3);  // Increments modCount!!
        elementData[size++] = e0;
        elementData[size++] = e1;
        elementData[size++] = e2;
     ...
     * @param e1 the second element to be appended to this list
     * @param e2 the third element to be appended to this list
     * @param e3 the fourth element to be appended to this list
     *
     * @return <tt>true</tt> (as specified by {@link Collection#add})
     */
    public boolean add(final float e0, final float e1, final float e2, final float e3) {
...
//        }
    ...
    /**
     * An iterator over the elements of a FloatArray.
     */
    ...
    public String toString() {
        ...
        return String.format("F[%s]", b.toString());
    }
}
