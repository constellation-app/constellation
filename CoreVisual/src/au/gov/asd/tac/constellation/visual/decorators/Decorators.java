 ...
 */
package au.gov.asd.tac.constellation.visual.decorators;
...
public class Decorators {
    ...
    public static final Decorators NO_DECORATORS = new Decorators(null, null, null, null);
    ...
    public Decorators(final String northWestDecoratorAttribute, final String northEastDecoratorAttribute,
    ...
    public static Decorators valueOf(final String decoratorsString) {
        ...
        if (decorators.size() == 4) {
            return new Decorators(decorators.get(0), decorators.get(1), decorators.get(2), decorators.get(3));
        }
