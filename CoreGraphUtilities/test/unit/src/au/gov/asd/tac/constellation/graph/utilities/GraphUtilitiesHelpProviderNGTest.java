 ...
 * @author antares
 */
public class GraphUtilitiesHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class GraphUtilitiesHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final GraphUtilitiesHelpProvider instance = new GraphUtilitiesHelpProvider();
        ...
        final String packageStart = "au.gov.asd.tac.constellation.graph.utilities.";
    ...
    /**
     * Test of getHelpTOC method, of class GraphUtilitiesHelpProvider.
     */
    @Test
