 ...
 * @author antares
 */
public class NotesViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class NotesViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final NotesViewHelpProvider instance = new NotesViewHelpProvider();
        ...
        //but will assert they're all correctly located within the notes package
        final String packageStart = "au.gov.asd.tac.constellation.views.notes.";
    ...
    /**
     * Test of getHelpTOC method, of class NotesViewHelpProvider.
     */
    @Test
