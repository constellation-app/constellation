...
public class NotesViewTopComponent extends JavaFxTopComponent<NotesViewPane> implements GraphReportListener, UndoRedoReportListener {
    ...
    protected void handleComponentOpened() {
        ...
        /**
         * listener is not removed so that plugin reports created when the Notes View is not open will render when it is
         * opened later.
         */
    ...
    public Tuple<String, Boolean> getDefaultFloatingInfo() {
        return Tuple.create(Bundle.CTL_NotesViewTopComponent(), Boolean.FALSE);
    }
