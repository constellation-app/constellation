 ...
 * @author altair1673
 */
public class PopularityHeatmapLayerNGTest {

    private static final Logger LOGGER = Logger.getLogger(PopularityHeatmapLayerNGTest.class.getName());

    public PopularityHeatmapLayerNGTest() {
    }
    ...
    /**
     * Test of getWeight method, of class PopularityHeatmapLayer.
     */
    @Test
    public void testGetWeight() {
        ...
        try (MockedStatic<GraphManager> graphManagerMock = Mockito.mockStatic(GraphManager.class)) {
            ...
            Mockito.when(readableGraph.getVertexNeighbourCount(vertexID)).thenReturn(4);
