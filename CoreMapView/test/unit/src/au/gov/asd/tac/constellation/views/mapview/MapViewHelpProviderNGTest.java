 ...
 * @author antares
 */
public class MapViewHelpProviderNGTest {
    ...
    /**
     * Test of getHelpMap method, of class MapViewHelpProvider.
     */
    @Test
    public void testGetHelpMap() {
        System.out.println("getHelpMap");
        
        final MapViewHelpProvider instance = new MapViewHelpProvider();
        ...
        //but will assert they're all correctly located within the map view package
        final String packageStart = "au.gov.asd.tac.constellation.views.mapview.";
    ...
    /**
     * Test of getHelpTOC method, of class MapViewHelpProvider.
     */
    @Test
