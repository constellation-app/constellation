...
import au.gov.asd.tac.constellation.views.mapview.overlays.*;
...
public abstract class MapOverlay {
    ...
    public void initialise(final au.gov.asd.tac.constellation.views.mapview2.MapViewTileRenderer renderer,
