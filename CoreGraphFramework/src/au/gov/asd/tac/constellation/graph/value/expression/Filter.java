...
public class Filter {
    ...
    public static <P1, V, O extends Readable<V>> Readable<V> createReadable(Readable<P1> parameter1, Class<O> operationClass, ConverterRegistry converterRegistry) {
        final P1 parameter1Value = parameter1.createValue();
        final var operation = converterRegistry.convert(parameter1Value, operationClass);
        ...
        return new Readable<V>() {
            ...
            public void read(V value) {
                parameter1.read(parameter1Value);
                operation.read(value);
            }
        };
    }
    ...
    public static <P1, P2, V, O extends Readable<V>> Readable<V> createReadable(Readable<P1> parameter1, Readable<P2> parameter2, Class<O> operationClass, ConverterRegistry converterRegistry) {
        final P1 parameter1Value = parameter1.createValue();
        final P2 parameter2Value = parameter2.createValue();
        final var operation = converterRegistry.convert(parameter1Value, parameter2Value, operationClass);
        ...
        return new Readable<V>() {
            ...
            public void read(V value) {
                parameter1.read(parameter1Value);
                parameter2.read(parameter2Value);
                operation.read(value);
            }
        };
    }
    ...
    public static <P1, V, O extends Readable<V>> Readable<V> createFilter(Readable<P1> parameter1, String parameter2, Class<O> operationClass, ConverterRegistry converterRegistry) {
        final var parameter1Value = parameter1.createValue();
        final var parameter2Value = parameter1.createValue();
    ...
    public static <P2, V, O extends Readable<V>> Readable<V> createFilter(String parameter1, Readable<P2> parameter2, Class<O> operationClass, ConverterRegistry converterRegistry) {
        final var parameter1Value = parameter2.createValue();
        final var parameter2Value = parameter2.createValue();
