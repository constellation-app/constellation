...
public interface ArithmeticOperation {
    ...
    default void register(OperatorRegistry registry) {
        registry.register(DoubleReadable.class, DoubleReadable.class, DoubleReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readDouble(), p2.readDouble()); 
        });
        registry.register(FloatReadable.class, FloatReadable.class, FloatReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readFloat(), p2.readFloat());
        });
        registry.register(LongReadable.class, LongReadable.class, LongReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readLong(), p2.readLong());
        });
        registry.register(IntReadable.class, IntReadable.class, IntReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readInt(), p2.readInt());
        });
        
        registry.register(DoubleReadable.class, StringReadable.class, DoubleReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readDouble(), Double.parseDouble(p2.readString()));
        });
        registry.register(FloatReadable.class, StringReadable.class, FloatReadable.class, (p1, p2) -> {
            return () -> execute(p1.readFloat(), Float.parseFloat(p2.readString()));
        });
        registry.register(LongReadable.class, StringReadable.class, LongReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readLong(), Long.parseLong(p2.readString()));
        });
        registry.register(IntReadable.class, StringReadable.class, IntReadable.class, (p1, p2) -> { 
            return () -> execute(p1.readInt(), Integer.parseInt(p2.readString()));
        });
        
        registry.register(StringReadable.class, DoubleReadable.class, DoubleReadable.class, (p1, p2) -> { 
            return () -> execute(Double.parseDouble(p1.readString()), p2.readDouble());
        });
        registry.register(StringReadable.class, FloatReadable.class, FloatReadable.class, (p1, p2) -> { 
            return () -> execute(Float.parseFloat(p1.readString()), p2.readFloat());
        });
        registry.register(StringReadable.class, LongReadable.class, LongReadable.class, (p1, p2) -> { 
            return () -> execute(Long.parseLong(p1.readString()), p2.readLong());
        });
        registry.register(StringReadable.class, IntReadable.class, IntReadable.class, (p1, p2) -> { 
            return () -> execute(Integer.parseInt(p1.readString()), p2.readInt());
        });
        
        registry.register(DoubleReadable.class, StringConstant.class, DoubleReadable.class, (p1, p2) -> { 
            final var p2Double = Double.parseDouble(p2.readString());
