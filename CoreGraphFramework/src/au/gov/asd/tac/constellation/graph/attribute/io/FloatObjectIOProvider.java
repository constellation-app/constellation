...
public class FloatObjectIOProvider extends AbstractGraphIOProvider {
    ...
    public void readObject(final int attributeId, final int elementId, final JsonNode jnode,
        ...
        final Float attribute = jnode.isNull() ? null : (float) jnode.doubleValue();
        graph.setObjectValue(attributeId, elementId, attribute);
    }
    ...
    public void writeObject(final Attribute attribute, final int elementId, final JsonGenerator jsonGenerator,
        ...
        if (verbose || !graph.isDefaultValue(attribute.getId(), elementId)) {
            final Float attributeValue = graph.getObjectValue(attribute.getId(), elementId);
