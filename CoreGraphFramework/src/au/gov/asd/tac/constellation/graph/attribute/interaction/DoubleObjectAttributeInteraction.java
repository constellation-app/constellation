 ...
 * {@link au.gov.asd.tac.constellation.graph.attribute.DoubleObjectAttributeDescription}
 *
 * @author cygnus_x-1
 */
@ServiceProvider(service = AbstractAttributeInteraction.class)
public class DoubleObjectAttributeInteraction extends DoubleAttributeInteraction {
