...
public class DoubleIOProvider extends AbstractGraphIOProvider {
    ...
    public void readObject(final int attributeId, final int elementId, final JsonNode jnode,
        ...
        final double attributeValue = jnode.doubleValue();
        graph.setDoubleValue(attributeId, elementId, attributeValue);
    }
    ...
    public void writeObject(final Attribute attribute, final int elementId, final JsonGenerator jsonGenerator,
        ...
        if (verbose || !graph.isDefaultValue(attribute.getId(), elementId)) {
            final double attributeValue = graph.getDoubleValue(attribute.getId(), elementId);
