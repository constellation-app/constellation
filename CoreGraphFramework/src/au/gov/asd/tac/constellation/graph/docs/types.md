...
data, such as \'Document\' or \'Person\'. Each node type holds the
...
category of relationship, such as \'Talked to\' or \'Meeting with\'.
Each transaction type holds the following properties\...
