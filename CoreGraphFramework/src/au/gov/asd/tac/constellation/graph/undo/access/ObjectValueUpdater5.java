...
public class ObjectValueUpdater5 implements ValueUpdater32 {
    ...
    private static final ValueGetter[] OBJECT_GETTERS = new ValueGetter[]{
        ...
        new ValueGetter() {
            @Override
            public void getExecute(UndoGraphEditState edit) {
                edit.currentObject ^= ((int) edit.getByteStack()[edit.getBytePointer()] - Byte.MIN_VALUE) << 3;
        ...
        new ValueGetter() {
            @Override
            public void getExecute(UndoGraphEditState edit) {
                edit.currentObject ^= ((int) edit.getShortStack()[edit.getShortPointer()] - Short.MIN_VALUE) << 3;
        ...
        new ValueGetter() {
            @Override
            public void getExecute(UndoGraphEditState edit) {
                edit.currentObject ^= (edit.getIntStack()[edit.getIntPointer()]) << 3;
