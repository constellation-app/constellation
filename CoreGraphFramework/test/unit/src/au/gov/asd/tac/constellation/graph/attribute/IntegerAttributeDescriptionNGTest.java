...
import au.gov.asd.tac.constellation.utilities.testing.ConstellationTest; 
 public class IntegerAttributeDescriptionNGTest extends ConstellationTest {
    ...
    public void testSetDefault() {
        ...
        assertEquals(instance.getDefault(), IntegerAttributeDescription.DEFAULT_VALUE);
    }
    ...
    public void testSetString() {
        ...
        assertEquals(instance.getString(id), String.valueOf(IntegerAttributeDescription.DEFAULT_VALUE));
        instance.setString(id, "42");
        assertEquals(instance.getString(id), "42");
    }
    
    /**
     * Test of setString method, of class IntegerAttributeDescription. Trying to convert a non-integer string to integer
     */
    @Test(expectedExceptions = IllegalArgumentException.class, 
            expectedExceptionsMessageRegExp = "Error converting String \'not an integer\' to integer")
    public void testSetStringCantConvert() {
        System.out.println("setStringCantConvert");
        
        int id = 0;
        instance.setString(id, "not an integer");
    }
    ...
    public void testAcceptsString() {
        ...
        assertEquals(instance.acceptsString("not an integer"), "Error converting String \'not an integer\' to integer");
    }
    ...
    public void testSetObject() {
        ...
        assertEquals(instance.getObject(id), IntegerAttributeDescription.DEFAULT_VALUE);
        instance.setObject(id, 42);
        assertEquals(instance.getObject(id), 42);
        instance.setObject(id, Boolean.TRUE);
        assertEquals(instance.getObject(id), 1);
        instance.setObject(id, Boolean.FALSE);
        assertEquals(instance.getObject(id), 0);
        instance.setObject(id, (char) 7);
        assertEquals(instance.getObject(id), 7);
        instance.setObject(id, "7");
        assertEquals(instance.getObject(id), 7);
    }
    
    /**
     * Test of setObject method, of class IntegerAttributeDescription. Trying to convert an incompatible type to integer
     */
    @Test(expectedExceptions = IllegalArgumentException.class, 
            expectedExceptionsMessageRegExp = "Error converting Object \'class java.time.LocalDate\' to integer")
