...
import au.gov.asd.tac.constellation.utilities.testing.ConstellationTest; 
 public class TimeZoneAttributeInteractionNGTest extends ConstellationTest {
    ...
    /**
     * Test of getDisplayText method, of class TimeZoneAttributeInteraction.
     */
    @Test
    public void testGetDisplayText() {
        System.out.println("getDisplayText");
        
        final TimeZoneAttributeInteraction instance = new TimeZoneAttributeInteraction();
        
        assertNull(instance.getDisplayText(null));
        assertEquals(instance.getDisplayText(ZoneId.of("UTC")), "+00:00 [UTC]");
    }
}
