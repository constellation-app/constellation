...
public class LongObjectIOProviderNGTest {
    ...
    public LongObjectIOProviderNGTest() {
    }
    ...
    public void setUpMethod() throws Exception {
        instance = new LongObjectIOProvider();
    }
    ...
    /**
     * Test of getName method, of class LongObjectIOProvider.
     */
    @Test
    public void testGetName() {
        System.out.println("LongObjectIOProviderNGTest.testGetName");
        assertEquals(instance.getName(), LongObjectAttributeDescription.ATTRIBUTE_NAME);
    }

    /**
     * Test of readObject method, of class LongObjectIOProvider.
     */
    @Test
    public void testReadObject() throws Exception {
        System.out.println("LongObjectIOProviderNGTest.testReadObject");
        ...
        Mockito.verify(mockJsonNode, times(0)).longValue();
        ...
        Mockito.verify(mockGraphWriteMethods, times(1)).setObjectValue(attributeId, elementId, (long)5);
    }

    /**
     * Test of writeObject method, of class LongObjectIOProvider.
     */
    @Test
    public void testWriteObject() throws Exception {
        System.out.println("LongObjectIOProviderNGTest.testWriteObject");
        ...
        // Test verbose and graph.IsDefaultValue is false, getObjectValue returns long
        resetMocking();
        when(mockGraphReadMethods.isDefaultValue(anyInt(), anyInt())).thenReturn(false);
        when(mockGraphReadMethods.getObjectValue(anyInt(), anyInt())).thenReturn((long)5);
        instance.writeObject(attr, elementId, mockJsonGenerator, mockGraphReadMethods, null, true);
