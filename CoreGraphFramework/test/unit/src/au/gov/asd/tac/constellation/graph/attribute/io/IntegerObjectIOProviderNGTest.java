...
import au.gov.asd.tac.constellation.utilities.testing.ConstellationTest; 
 public class IntegerObjectIOProviderNGTest extends ConstellationTest {

    // Create object under test
    IntegerObjectIOProvider instance;
    ...
    public IntegerObjectIOProviderNGTest() {
    }
    ...
    public void setUpMethod() throws Exception {
        instance = new IntegerObjectIOProvider();
    }
    ...
    /**
     * Test of getName method, of class IntegerObjectIOProvider.
     */
    @Test
    public void testGetName() {
        System.out.println("IntegerObjectIOProviderNGTest.testGetName");
        assertEquals(instance.getName(), IntegerObjectAttributeDescription.ATTRIBUTE_NAME);
    }

    /**
     * Test of readObject method, of class IntegerObjectIOProvider.
     */
    @Test
    public void testReadObject() throws Exception {
        System.out.println("IntegerObjectIOProviderNGTest.testReadObject");
        ...
        Mockito.verify(mockJsonNode, times(0)).intValue();
        ...
        Mockito.verify(mockGraphWriteMethods, times(1)).setObjectValue(attributeId, elementId, 5);
    }

    /**
     * Test of writeObject method, of class IntegerObjectIOProvider.
     */
    @Test
    public void testWriteObject() throws Exception {
        System.out.println("IntegerObjectIOProviderNGTest.testWriteObject");
        ...
        // Test verbose and graph.IsDefaultValue is false, getObjectValue returns int
        resetMocking();
        when(mockGraphReadMethods.isDefaultValue(anyInt(), anyInt())).thenReturn(false);
        when(mockGraphReadMethods.getObjectValue(anyInt(), anyInt())).thenReturn(5);
        instance.writeObject(attr, elementId, mockJsonGenerator, mockGraphReadMethods, null, true);
