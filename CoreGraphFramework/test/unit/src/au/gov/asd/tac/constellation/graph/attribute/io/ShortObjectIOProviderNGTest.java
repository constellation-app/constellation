...
import au.gov.asd.tac.constellation.utilities.testing.ConstellationTest; 
 public class ShortObjectIOProviderNGTest extends ConstellationTest {

    // Create object under test
    ShortObjectIOProvider instance;
    ...
    public ShortObjectIOProviderNGTest() {
    }
    ...
    public void setUpMethod() throws Exception {
        instance = new ShortObjectIOProvider();
    }
    ...
    /**
     * Test of getName method, of class ShortObjectIOProvider.
     */
    @Test
    public void testGetName() {
        System.out.println("ShortObjectIOProviderNGTest.testGetName");
        assertEquals(instance.getName(), ShortObjectAttributeDescription.ATTRIBUTE_NAME);
    }

    /**
     * Test of readObject method, of class ShortObjectIOProvider.
     */
    @Test
    public void testReadObject() throws Exception {
        System.out.println("ShortObjectIOProviderNGTest.testReadObject");
        ...
        when(mockJsonNode.asInt()).thenReturn(5);
        instance.readObject(attributeId, elementId, mockJsonNode, mockGraphWriteMethods, null, null, null, null);
        Mockito.verify(mockJsonNode, times(1)).asInt();
        Mockito.verify(mockGraphWriteMethods, times(1)).setObjectValue(attributeId, elementId, (short)5);
    }

    /**
     * Test of writeObject method, of class ShortObjectIOProvider.
     */
    @Test
    public void testWriteObject() throws Exception {
        System.out.println("ShortObjectIOProviderNGTest.testWriteObject");
        ...
        // Test verbose and graph.IsDefaultValue is false, getObjectValue returns short
        resetMocking();
        when(mockGraphReadMethods.isDefaultValue(anyInt(), anyInt())).thenReturn(false);
        when(mockGraphReadMethods.getObjectValue(anyInt(), anyInt())).thenReturn((short)5);
        instance.writeObject(attr, elementId, mockJsonGenerator, mockGraphReadMethods, null, true);
        Mockito.verify(mockJsonGenerator, times(0)).writeNullField(anyString());
        Mockito.verify(mockJsonGenerator, times(1)).writeNumberField(attr.getName(), (short)5);
    }
}
