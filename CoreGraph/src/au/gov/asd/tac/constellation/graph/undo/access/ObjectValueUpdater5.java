...
public class ObjectValueUpdater5 implements ValueUpdater32 {
    ...
    public static final ValueGetter[] OBJECT_GETTERS = new ValueGetter[]{
        ...
        new ValueGetter() {
            @Override
            public void getExecute(UndoGraphEditState edit) {
                edit.currentObject ^= ((int) edit.byteStack[edit.bytePointer++] - Byte.MIN_VALUE) << 3;
            }
        ...
        new ValueGetter() {
            @Override
            public void getExecute(UndoGraphEditState edit) {
                edit.currentObject ^= ((int) edit.shortStack[edit.shortPointer++] - Short.MIN_VALUE) << 3;
            }
        ...
        new ValueGetter() {
            @Override
            public void getExecute(UndoGraphEditState edit) {
                edit.currentObject ^= (edit.intStack[edit.intPointer++]) << 3;
            }
