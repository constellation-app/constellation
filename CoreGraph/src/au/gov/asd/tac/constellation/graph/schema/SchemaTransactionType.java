...
public final class SchemaTransactionType extends SchemaElementType<SchemaTransactionType> implements Comparable<SchemaTransactionType> {
     ...
     * SchemaTransactionType.
     *
     * @return A {@link LineStyle} representing the default style to use for
    ...
    public static class Builder {
        ...
        public Builder setColor(ConstellationColor color) {
            this.color = color;
            return this;
        }
        ...
        public Builder setSuperType(SchemaTransactionType superType) {
            this.superType = superType;
            return this;
        }

        public Builder setOverridenType(SchemaTransactionType overridenType) {
            this.overridenType = overridenType;
            return this;
        }

        public Builder setProperty(String propertyKey, String propertyValue) {
